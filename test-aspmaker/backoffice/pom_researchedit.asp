...
' Define page object
Dim research_edit
Set research_edit = New cresearch_edit
Set Page = research_edit

' Page init processing
research_edit.Page_Init()

' Page main processing
research_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
research_edit.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var research_edit = new ew_Page("research_edit");
research_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = research_edit.PageID; // For backward compatibility
// Form object
var fresearchedit = new ew_Form("fresearchedit");
// Validate form
fresearchedit.Validate = function() {
...
fresearchedit.Form_CustomValidate = 
...
fresearchedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fresearchedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% research_edit.ShowPageHeader() %>
<% research_edit.ShowMessage %>
<form name="fresearchedit" id="fresearchedit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="a_table" id="a_table" value="research">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_researchedit" class="table table-bordered table-striped">
...
<%= research.rsh_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_rsh_id" name="x_rsh_id" id="x_rsh_id" value="<%= Server.HTMLEncode(research.rsh_id.CurrentValue&"") %>">
...
Class cresearch_edit
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			research.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			research.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If research.rsh_id.CurrentValue = "" Then Call Page_Terminate("pom_researchlist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				research.CurrentAction = "" ' Form error, reset action
		...
		Select Case research.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				research.SendEmail = True ' Send email on update success
		...
		' Render the record
		research.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Sub RenderRow()
		...
		ElseIf research.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' rsh_id
			research.rsh_id.EditCustomAttributes = ""
			research.rsh_id.EditValue = research.rsh_id.CurrentValue
			research.rsh_id.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			Call research.rsh_img.SetDbValue(Rs, research.rsh_img.CurrentValue, Null, research.rsh_img.ReadOnly)

			' Field rsh_date
			Call research.rsh_date.SetDbValue(Rs, research.rsh_date.CurrentValue, Null, research.rsh_date.ReadOnly)

			' Field rsh_pdf
			Call research.rsh_pdf.SetDbValue(Rs, research.rsh_pdf.CurrentValue, Null, research.rsh_pdf.ReadOnly)

			' Field rsh_category
			Call research.rsh_category.SetDbValue(Rs, research.rsh_category.CurrentValue, Null, research.rsh_category.ReadOnly)

			' Field rsh_subject
			Call research.rsh_subject.SetDbValue(Rs, research.rsh_subject.CurrentValue, Null, research.rsh_subject.ReadOnly)

			' Field rsh_subject_th
			Call research.rsh_subject_th.SetDbValue(Rs, research.rsh_subject_th.CurrentValue, Null, research.rsh_subject_th.ReadOnly)

			' Field rsh_intro
			Call research.rsh_intro.SetDbValue(Rs, research.rsh_intro.CurrentValue, Null, research.rsh_intro.ReadOnly)

			' Field rsh_intro_th
			Call research.rsh_intro_th.SetDbValue(Rs, research.rsh_intro_th.CurrentValue, Null, research.rsh_intro_th.ReadOnly)

			' Field rsh_content
			Call research.rsh_content.SetDbValue(Rs, research.rsh_content.CurrentValue, Null, research.rsh_content.ReadOnly)

			' Field rsh_content_th
			Call research.rsh_content_th.SetDbValue(Rs, research.rsh_content_th.CurrentValue, Null, research.rsh_content_th.ReadOnly)

			' Field rsh_show
			Call research.rsh_show.SetDbValue(Rs, research.rsh_show.CurrentValue, Null, research.rsh_show.ReadOnly)

			' Field rsh_show_home
			Call research.rsh_show_home.SetDbValue(Rs, research.rsh_show_home.CurrentValue, Null, research.rsh_show_home.ReadOnly)

			' Field rsh_create
			Call research.rsh_create.SetDbValue(Rs, research.rsh_create.CurrentValue, Null, research.rsh_create.ReadOnly)

			' Field rsh_update
			Call research.rsh_update.SetDbValue(Rs, research.rsh_update.CurrentValue, Null, research.rsh_update.ReadOnly)
			...
			bUpdateRow = research.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call research.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
