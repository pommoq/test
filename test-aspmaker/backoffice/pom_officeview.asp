...
' Define page object
Dim office_view
Set office_view = New coffice_view
Set Page = office_view

' Page init processing
office_view.Page_Init()

' Page main processing
office_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
office_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If office.Export = "" Then %>
<script type="text/javascript">
// Page object
var office_view = new ew_Page("office_view");
office_view.PageID = "view"; // Page ID
var EW_PAGE_ID = office_view.PageID; // For backward compatibility
// Form object
var fofficeview = new ew_Form("fofficeview");
// Form_CustomValidate event
fofficeview.Form_CustomValidate = 
...
fofficeview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fofficeview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% office_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not office_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	office_view.ActionOptions.Render "body", "", "", "", "", ""
	office_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% office_view.ShowPageHeader() %>
<% office_view.ShowMessage %>
<form name="fofficeview" id="fofficeview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="office">
<table class="ewGrid"><tr><td>
<table id="tbl_officeview" class="table table-bordered table-striped">
...
<%= office.office_name_en.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= office.office_name_th.ViewValue %>
</span>
</span>
</td>
	</tr>
...
Class coffice_view
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_officelist.asp" ' Return to list
			End If

			' Get action
			office.CurrentAction = "I" ' Display form
			Select Case office.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_officelist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_officelist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		office.RowType = EW_ROWTYPE_VIEW
