...
' Define page object
Dim vehicle_record_th_add
Set vehicle_record_th_add = New cvehicle_record_th_add
Set Page = vehicle_record_th_add

' Page init processing
vehicle_record_th_add.Page_Init()

' Page main processing
vehicle_record_th_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
vehicle_record_th_add.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var vehicle_record_th_add = new ew_Page("vehicle_record_th_add");
vehicle_record_th_add.PageID = "add"; // Page ID
var EW_PAGE_ID = vehicle_record_th_add.PageID; // For backward compatibility
// Form object
var fvehicle_record_thadd = new ew_Form("fvehicle_record_thadd");
// Validate form
fvehicle_record_thadd.Validate = function() {
...
fvehicle_record_thadd.Form_CustomValidate = 
...
fvehicle_record_thadd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fvehicle_record_thadd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% vehicle_record_th_add.ShowPageHeader() %>
<% vehicle_record_th_add.ShowMessage %>
<form name="fvehicle_record_thadd" id="fvehicle_record_thadd" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="vehicle_record_th">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_vehicle_record_thadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fvehicle_record_thadd.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
vehicle_record_th_add.ShowPageFooter()
...
' Drop page object
Set vehicle_record_th_add = Nothing
%>
<%
...
Class cvehicle_record_th_add
	...
	Public Property Get PageObjName()
		PageObjName = "vehicle_record_th_add"
	End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			vehicle_record_th.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("veh_id").Count > 0 Then
				...
				Call vehicle_record_th.SetKey("veh_id", vehicle_record_th.veh_id.CurrentValue) ' Set up key
			Else
				Call vehicle_record_th.SetKey("veh_id", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
				vehicle_record_th.CurrentAction = "C" ' Copy Record
			Else
				vehicle_record_th.CurrentAction = "I" ' Display Blank Record
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			If Not ValidateForm() Then
				vehicle_record_th.CurrentAction = "I" ' Form error, reset action
		...
		Select Case vehicle_record_th.CurrentAction
			...
			Case "A" ' Add new record
				vehicle_record_th.SendEmail = True ' Send email on add success
				If AddRow(OldRecordset) Then ' Add successful
					SuccessMessage = Language.Phrase("AddSuccess") ' Set up success message
					Dim sReturnUrl
					sReturnUrl = vehicle_record_th.ReturnUrl
					If ew_GetPageName(sReturnUrl) = "pom_vehicle_record_thview.asp" Then sReturnUrl = vehicle_record_th.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		vehicle_record_th.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Function LoadDefaultValues()
		vehicle_record_th.vch_month.CurrentValue = Null
		vehicle_record_th.vch_month.OldValue = vehicle_record_th.vch_month.CurrentValue
		vehicle_record_th.vch_year.CurrentValue = Null
		vehicle_record_th.vch_year.OldValue = vehicle_record_th.vch_year.CurrentValue
		vehicle_record_th.veh_product_1.CurrentValue = Null
		vehicle_record_th.veh_product_1.OldValue = vehicle_record_th.veh_product_1.CurrentValue
		vehicle_record_th.veh_product_2.CurrentValue = Null
		vehicle_record_th.veh_product_2.OldValue = vehicle_record_th.veh_product_2.CurrentValue
		vehicle_record_th.veh_product_3.CurrentValue = Null
		vehicle_record_th.veh_product_3.OldValue = vehicle_record_th.veh_product_3.CurrentValue
		vehicle_record_th.veh_product_4.CurrentValue = Null
		vehicle_record_th.veh_product_4.OldValue = vehicle_record_th.veh_product_4.CurrentValue
		vehicle_record_th.veh_product_5.CurrentValue = Null
		vehicle_record_th.veh_product_5.OldValue = vehicle_record_th.veh_product_5.CurrentValue
		vehicle_record_th.veh_product_6.CurrentValue = Null
		vehicle_record_th.veh_product_6.OldValue = vehicle_record_th.veh_product_6.CurrentValue
		vehicle_record_th.veh_product_7.CurrentValue = Null
		vehicle_record_th.veh_product_7.OldValue = vehicle_record_th.veh_product_7.CurrentValue
		vehicle_record_th.veh_product_8.CurrentValue = Null
		vehicle_record_th.veh_product_8.OldValue = vehicle_record_th.veh_product_8.CurrentValue
		vehicle_record_th.veh_domes_1.CurrentValue = Null
		vehicle_record_th.veh_domes_1.OldValue = vehicle_record_th.veh_domes_1.CurrentValue
		vehicle_record_th.veh_domes_2.CurrentValue = Null
		vehicle_record_th.veh_domes_2.OldValue = vehicle_record_th.veh_domes_2.CurrentValue
		vehicle_record_th.veh_domes_3.CurrentValue = Null
		vehicle_record_th.veh_domes_3.OldValue = vehicle_record_th.veh_domes_3.CurrentValue
		vehicle_record_th.veh_domes_4.CurrentValue = Null
		vehicle_record_th.veh_domes_4.OldValue = vehicle_record_th.veh_domes_4.CurrentValue
		vehicle_record_th.veh_domes_5.CurrentValue = Null
		vehicle_record_th.veh_domes_5.OldValue = vehicle_record_th.veh_domes_5.CurrentValue
		vehicle_record_th.veh_domes_6.CurrentValue = Null
		vehicle_record_th.veh_domes_6.OldValue = vehicle_record_th.veh_domes_6.CurrentValue
		vehicle_record_th.veh_domes_7.CurrentValue = Null
		vehicle_record_th.veh_domes_7.OldValue = vehicle_record_th.veh_domes_7.CurrentValue
		vehicle_record_th.veh_domes_8.CurrentValue = Null
		vehicle_record_th.veh_domes_8.OldValue = vehicle_record_th.veh_domes_8.CurrentValue
		vehicle_record_th.veh_export_1.CurrentValue = Null
		vehicle_record_th.veh_export_1.OldValue = vehicle_record_th.veh_export_1.CurrentValue
		vehicle_record_th.veh_export_2.CurrentValue = Null
		vehicle_record_th.veh_export_2.OldValue = vehicle_record_th.veh_export_2.CurrentValue
		vehicle_record_th.veh_export_3.CurrentValue = Null
		vehicle_record_th.veh_export_3.OldValue = vehicle_record_th.veh_export_3.CurrentValue
		vehicle_record_th.veh_export_4.CurrentValue = Null
		vehicle_record_th.veh_export_4.OldValue = vehicle_record_th.veh_export_4.CurrentValue
		vehicle_record_th.veh_export_5.CurrentValue = Null
		vehicle_record_th.veh_export_5.OldValue = vehicle_record_th.veh_export_5.CurrentValue
		vehicle_record_th.veh_export_6.CurrentValue = Null
		vehicle_record_th.veh_export_6.OldValue = vehicle_record_th.veh_export_6.CurrentValue
		vehicle_record_th.veh_export_7.CurrentValue = Null
		vehicle_record_th.veh_export_7.OldValue = vehicle_record_th.veh_export_7.CurrentValue
		vehicle_record_th.veh_export_8.CurrentValue = Null
		vehicle_record_th.veh_export_8.OldValue = vehicle_record_th.veh_export_8.CurrentValue
		vehicle_record_th.veh_remark.CurrentValue = Null
		vehicle_record_th.veh_remark.OldValue = vehicle_record_th.veh_remark.CurrentValue
		vehicle_record_th.veh_month_title.CurrentValue = Null
		vehicle_record_th.veh_month_title.OldValue = vehicle_record_th.veh_month_title.CurrentValue
		vehicle_record_th.veh_range.CurrentValue = Null
		vehicle_record_th.veh_range.OldValue = vehicle_record_th.veh_range.CurrentValue
		vehicle_record_th.veh_month_title2.CurrentValue = Null
		vehicle_record_th.veh_month_title2.OldValue = vehicle_record_th.veh_month_title2.CurrentValue
		vehicle_record_th.veh_range2.CurrentValue = Null
		vehicle_record_th.veh_range2.OldValue = vehicle_record_th.veh_range2.CurrentValue
	End Function
	...
	Sub RenderRow()
		...
		ElseIf vehicle_record_th.RowType = EW_ROWTYPE_ADD Then ' Add row
	...
	Function AddRow(RsOld)
		...
		' Field vch_month
		Call vehicle_record_th.vch_month.SetDbValue(Rs, vehicle_record_th.vch_month.CurrentValue, Null, False)

		' Field vch_year
		Call vehicle_record_th.vch_year.SetDbValue(Rs, vehicle_record_th.vch_year.CurrentValue, Null, False)

		' Field veh_product_1
		Call vehicle_record_th.veh_product_1.SetDbValue(Rs, vehicle_record_th.veh_product_1.CurrentValue, Null, False)

		' Field veh_product_2
		Call vehicle_record_th.veh_product_2.SetDbValue(Rs, vehicle_record_th.veh_product_2.CurrentValue, Null, False)

		' Field veh_product_3
		Call vehicle_record_th.veh_product_3.SetDbValue(Rs, vehicle_record_th.veh_product_3.CurrentValue, Null, False)

		' Field veh_product_4
		Call vehicle_record_th.veh_product_4.SetDbValue(Rs, vehicle_record_th.veh_product_4.CurrentValue, Null, False)

		' Field veh_product_5
		Call vehicle_record_th.veh_product_5.SetDbValue(Rs, vehicle_record_th.veh_product_5.CurrentValue, Null, False)

		' Field veh_product_6
		Call vehicle_record_th.veh_product_6.SetDbValue(Rs, vehicle_record_th.veh_product_6.CurrentValue, Null, False)

		' Field veh_product_7
		Call vehicle_record_th.veh_product_7.SetDbValue(Rs, vehicle_record_th.veh_product_7.CurrentValue, Null, False)

		' Field veh_product_8
		Call vehicle_record_th.veh_product_8.SetDbValue(Rs, vehicle_record_th.veh_product_8.CurrentValue, Null, False)

		' Field veh_domes_1
		Call vehicle_record_th.veh_domes_1.SetDbValue(Rs, vehicle_record_th.veh_domes_1.CurrentValue, Null, False)

		' Field veh_domes_2
		Call vehicle_record_th.veh_domes_2.SetDbValue(Rs, vehicle_record_th.veh_domes_2.CurrentValue, Null, False)

		' Field veh_domes_3
		Call vehicle_record_th.veh_domes_3.SetDbValue(Rs, vehicle_record_th.veh_domes_3.CurrentValue, Null, False)

		' Field veh_domes_4
		Call vehicle_record_th.veh_domes_4.SetDbValue(Rs, vehicle_record_th.veh_domes_4.CurrentValue, Null, False)

		' Field veh_domes_5
		Call vehicle_record_th.veh_domes_5.SetDbValue(Rs, vehicle_record_th.veh_domes_5.CurrentValue, Null, False)

		' Field veh_domes_6
		Call vehicle_record_th.veh_domes_6.SetDbValue(Rs, vehicle_record_th.veh_domes_6.CurrentValue, Null, False)

		' Field veh_domes_7
		Call vehicle_record_th.veh_domes_7.SetDbValue(Rs, vehicle_record_th.veh_domes_7.CurrentValue, Null, False)

		' Field veh_domes_8
		Call vehicle_record_th.veh_domes_8.SetDbValue(Rs, vehicle_record_th.veh_domes_8.CurrentValue, Null, False)

		' Field veh_export_1
		Call vehicle_record_th.veh_export_1.SetDbValue(Rs, vehicle_record_th.veh_export_1.CurrentValue, Null, False)

		' Field veh_export_2
		Call vehicle_record_th.veh_export_2.SetDbValue(Rs, vehicle_record_th.veh_export_2.CurrentValue, Null, False)

		' Field veh_export_3
		Call vehicle_record_th.veh_export_3.SetDbValue(Rs, vehicle_record_th.veh_export_3.CurrentValue, Null, False)

		' Field veh_export_4
		Call vehicle_record_th.veh_export_4.SetDbValue(Rs, vehicle_record_th.veh_export_4.CurrentValue, Null, False)

		' Field veh_export_5
		Call vehicle_record_th.veh_export_5.SetDbValue(Rs, vehicle_record_th.veh_export_5.CurrentValue, Null, False)

		' Field veh_export_6
		Call vehicle_record_th.veh_export_6.SetDbValue(Rs, vehicle_record_th.veh_export_6.CurrentValue, Null, False)

		' Field veh_export_7
		Call vehicle_record_th.veh_export_7.SetDbValue(Rs, vehicle_record_th.veh_export_7.CurrentValue, Null, False)

		' Field veh_export_8
		Call vehicle_record_th.veh_export_8.SetDbValue(Rs, vehicle_record_th.veh_export_8.CurrentValue, Null, False)

		' Field veh_remark
		Call vehicle_record_th.veh_remark.SetDbValue(Rs, vehicle_record_th.veh_remark.CurrentValue, Null, False)

		' Field veh_month_title
		Call vehicle_record_th.veh_month_title.SetDbValue(Rs, vehicle_record_th.veh_month_title.CurrentValue, Null, False)

		' Field veh_range
		Call vehicle_record_th.veh_range.SetDbValue(Rs, vehicle_record_th.veh_range.CurrentValue, Null, False)

		' Field veh_month_title2
		Call vehicle_record_th.veh_month_title2.SetDbValue(Rs, vehicle_record_th.veh_month_title2.CurrentValue, Null, False)

		' Field veh_range2
		Call vehicle_record_th.veh_range2.SetDbValue(Rs, vehicle_record_th.veh_range2.CurrentValue, Null, False)
		...
		bInsertRow = vehicle_record_th.Row_Inserting(RsOld, Rs)
		If bInsertRow Then
		...
		Set Rs = Nothing
		If AddRow Then
			vehicle_record_th.veh_id.DbValue = RsNew("veh_id")
		End If
		If AddRow Then

			' Call Row Inserted event
			Call vehicle_record_th.Row_Inserted(RsOld, RsNew)
		End If
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(vehicle_record_th.CurrentAction = "C", "Copy", "Add")
