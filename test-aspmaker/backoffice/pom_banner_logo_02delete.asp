...
' Define page object
Dim banner_logo_02_delete
Set banner_logo_02_delete = New cbanner_logo_02_delete
Set Page = banner_logo_02_delete

' Page init processing
banner_logo_02_delete.Page_Init()

' Page main processing
banner_logo_02_delete.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
banner_logo_02_delete.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var banner_logo_02_delete = new ew_Page("banner_logo_02_delete");
banner_logo_02_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = banner_logo_02_delete.PageID; // For backward compatibility
// Form object
var fbanner_logo_02delete = new ew_Form("fbanner_logo_02delete");
// Form_CustomValidate event
fbanner_logo_02delete.Form_CustomValidate = 
...
fbanner_logo_02delete.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fbanner_logo_02delete.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
Set banner_logo_02_delete.Recordset = banner_logo_02_delete.LoadRecordset()
banner_logo_02_delete.TotalRecs = banner_logo_02_delete.Recordset.RecordCount ' Get record count
If banner_logo_02_delete.TotalRecs <= 0 Then ' No record found, exit
	banner_logo_02_delete.Recordset.Close
	Set banner_logo_02_delete.Recordset = Nothing
	Call banner_logo_02_delete.Page_Terminate("pom_banner_logo_02list.asp") ' Return to list
End If
%>
<% If banner_logo_02.Export = "" Then %>
<% Breadcrumb.Render() %>
<% End If %>
<% banner_logo_02_delete.ShowPageHeader() %>
<% banner_logo_02_delete.ShowMessage %>
<form name="fbanner_logo_02delete" id="fbanner_logo_02delete" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="banner_logo_02">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<% For i = 0 to UBound(banner_logo_02_delete.RecKeys) %>
<input type="hidden" name="key_m" id="key_m" value="<%= ew_HtmlEncode(ew_GetKeyValue(banner_logo_02_delete.RecKeys(i))) %>">
<% Next %>
<table class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_banner_logo_02delete" class="ewTable ewTableSeparate">
<%= banner_logo_02.TableCustomInnerHtml %>
	<thead>
	<tr class="ewTableHeader">
<% If banner_logo_02.banner_id.Visible Then ' banner_id %>
		<td><span id="elh_banner_logo_02_banner_id" class="banner_logo_02_banner_id"><%= banner_logo_02.banner_id.FldCaption %></span></td>
<% End If %>
<% If banner_logo_02.banner_img.Visible Then ' banner_img %>
		<td><span id="elh_banner_logo_02_banner_img" class="banner_logo_02_banner_img"><%= banner_logo_02.banner_img.FldCaption %></span></td>
<% End If %>
<% If banner_logo_02.banner_link.Visible Then ' banner_link %>
		<td><span id="elh_banner_logo_02_banner_link" class="banner_logo_02_banner_link"><%= banner_logo_02.banner_link.FldCaption %></span></td>
<% End If %>
<% If banner_logo_02.banner_sort.Visible Then ' banner_sort %>
		<td><span id="elh_banner_logo_02_banner_sort" class="banner_logo_02_banner_sort"><%= banner_logo_02.banner_sort.FldCaption %></span></td>
<% End If %>
<% If banner_logo_02.start_date.Visible Then ' start_date %>
		<td><span id="elh_banner_logo_02_start_date" class="banner_logo_02_start_date"><%= banner_logo_02.start_date.FldCaption %></span></td>
<% End If %>
<% If banner_logo_02.end_date.Visible Then ' end_date %>
		<td><span id="elh_banner_logo_02_end_date" class="banner_logo_02_end_date"><%= banner_logo_02.end_date.FldCaption %></span></td>
<% End If %>
	</tr>
	</thead>
	<tbody>
<%
banner_logo_02_delete.RecCnt = 0
banner_logo_02_delete.RowCnt = 0
Do While (Not banner_logo_02_delete.Recordset.Eof)
	banner_logo_02_delete.RecCnt = banner_logo_02_delete.RecCnt + 1
	banner_logo_02_delete.RowCnt = banner_logo_02_delete.RowCnt + 1

	' Set row properties
	Call banner_logo_02.ResetAttrs()
	banner_logo_02.RowType = EW_ROWTYPE_VIEW ' view

	' Get the field contents
	Call banner_logo_02_delete.LoadRowValues(banner_logo_02_delete.Recordset)

	' Render row
	Call banner_logo_02_delete.RenderRow()
%>
	<tr<%= banner_logo_02.RowAttributes %>>
<% If banner_logo_02.banner_id.Visible Then ' banner_id %>
		<td<%= banner_logo_02.banner_id.CellAttributes %>>
<span id="el<%= banner_logo_02_delete.RowCnt %>_banner_logo_02_banner_id" class="control-group banner_logo_02_banner_id">
...
<span id="el<%= banner_logo_02_delete.RowCnt %>_banner_logo_02_banner_img" class="control-group banner_logo_02_banner_img">
...
<span id="el<%= banner_logo_02_delete.RowCnt %>_banner_logo_02_banner_link" class="control-group banner_logo_02_banner_link">
...
<span id="el<%= banner_logo_02_delete.RowCnt %>_banner_logo_02_banner_sort" class="control-group banner_logo_02_banner_sort">
...
<span id="el<%= banner_logo_02_delete.RowCnt %>_banner_logo_02_start_date" class="control-group banner_logo_02_start_date">
...
<span id="el<%= banner_logo_02_delete.RowCnt %>_banner_logo_02_end_date" class="control-group banner_logo_02_end_date">
...
<%
	banner_logo_02_delete.Recordset.MoveNext
Loop
banner_logo_02_delete.Recordset.Close
Set banner_logo_02_delete.Recordset = Nothing
%>
...
<script type="text/javascript">
fbanner_logo_02delete.Init();
</script>
<%
banner_logo_02_delete.ShowPageFooter()
...
' Drop page object
Set banner_logo_02_delete = Nothing
%>
<%
...
Class cbanner_logo_02_delete
	...
	Public Property Get PageObjName()
		PageObjName = "banner_logo_02_delete"
	End Property
	...
	Sub Page_Main()
		...
		' Load Key Parameters
		RecKeys = banner_logo_02.GetRecordKeys() ' Load record keys
		sFilter = banner_logo_02.GetKeyFilter()
		If sFilter = "" Then
			Call Page_Terminate("pom_banner_logo_02list.asp") ' Prevent SQL injection, return to list
		End If

		' Set up filter (Sql Where Clause) and get Return Sql
		' Sql constructor in banner_logo_02 class, banner_logo_02info.asp

		banner_logo_02.CurrentFilter = sFilter

		' Get action
		If Request.Form("a_delete").Count > 0 Then
			banner_logo_02.CurrentAction = Request.Form("a_delete")
		Else
			banner_logo_02.CurrentAction = "I"	' Display record
		End If
		Select Case banner_logo_02.CurrentAction
			Case "D" ' Delete
				banner_logo_02.SendEmail = True ' Send email on delete success
				If DeleteRows() Then ' Delete rows
					SuccessMessage = Language.Phrase("DeleteSuccess") ' Set up success message
					Call Page_Terminate(banner_logo_02.ReturnUrl) ' Return to caller
				End If
		End Select
	End Sub
	...
	Function DeleteRows()
		...
		If DeleteRows Then
			...
			Do While Not RsDelete.Eof
				DeleteRows = banner_logo_02.Row_Deleting(RsDelete)
		...
		If DeleteRows Then
			...
			Do While Not RsOld.Eof
				Call banner_logo_02.Row_Deleted(RsOld)
				RsOld.MoveNext
			Loop
		End If
		RsOld.Close
