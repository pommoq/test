...
' Define page object
Dim vehicle_record_edit
Set vehicle_record_edit = New cvehicle_record_edit
Set Page = vehicle_record_edit

' Page init processing
vehicle_record_edit.Page_Init()

' Page main processing
vehicle_record_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
vehicle_record_edit.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var vehicle_record_edit = new ew_Page("vehicle_record_edit");
vehicle_record_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = vehicle_record_edit.PageID; // For backward compatibility
// Form object
var fvehicle_recordedit = new ew_Form("fvehicle_recordedit");
// Validate form
fvehicle_recordedit.Validate = function() {
...
fvehicle_recordedit.Form_CustomValidate = 
...
fvehicle_recordedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fvehicle_recordedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% vehicle_record_edit.ShowPageHeader() %>
<% vehicle_record_edit.ShowMessage %>
<form name="fvehicle_recordedit" id="fvehicle_recordedit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="a_table" id="a_table" value="vehicle_record">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_vehicle_recordedit" class="table table-bordered table-striped">
...
<%= vehicle_record.veh_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_veh_id" name="x_veh_id" id="x_veh_id" value="<%= Server.HTMLEncode(vehicle_record.veh_id.CurrentValue&"") %>">
<%= vehicle_record.veh_id.CustomMsg %></td>
	</tr>
<% End If %>
...
<script type="text/javascript">
fvehicle_recordedit.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
vehicle_record_edit.ShowPageFooter()
...
' Drop page object
Set vehicle_record_edit = Nothing
%>
<%
...
Class cvehicle_record_edit
	...
	Public Property Get PageObjName()
		PageObjName = "vehicle_record_edit"
	End Property
	...
	Sub Page_Init()
		...
		vehicle_record.veh_id.Visible = Not vehicle_record.IsAdd() And Not vehicle_record.IsCopy() And Not vehicle_record.IsGridAdd()
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			vehicle_record.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			vehicle_record.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If vehicle_record.veh_id.CurrentValue = "" Then Call Page_Terminate("pom_vehicle_recordlist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				vehicle_record.CurrentAction = "" ' Form error, reset action
		...
		Select Case vehicle_record.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				vehicle_record.SendEmail = True ' Send email on update success
		...
		' Render the record
		vehicle_record.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Function LoadFormValues()
		...
		If Not vehicle_record.veh_id.FldIsDetailKey Then vehicle_record.veh_id.FormValue = ObjForm.GetValue("x_veh_id")
	...
	Function RestoreFormValues()
		Call LoadRow()
		vehicle_record.veh_id.CurrentValue = vehicle_record.veh_id.FormValue
	...
	Sub RenderRow()
		...
		ElseIf vehicle_record.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' veh_id
			vehicle_record.veh_id.EditCustomAttributes = ""
			vehicle_record.veh_id.EditValue = vehicle_record.veh_id.CurrentValue
			vehicle_record.veh_id.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			' Field vch_month
			Call vehicle_record.vch_month.SetDbValue(Rs, vehicle_record.vch_month.CurrentValue, Null, vehicle_record.vch_month.ReadOnly)

			' Field vch_year
			Call vehicle_record.vch_year.SetDbValue(Rs, vehicle_record.vch_year.CurrentValue, Null, vehicle_record.vch_year.ReadOnly)

			' Field veh_product_1
			Call vehicle_record.veh_product_1.SetDbValue(Rs, vehicle_record.veh_product_1.CurrentValue, Null, vehicle_record.veh_product_1.ReadOnly)

			' Field veh_product_2
			Call vehicle_record.veh_product_2.SetDbValue(Rs, vehicle_record.veh_product_2.CurrentValue, Null, vehicle_record.veh_product_2.ReadOnly)

			' Field veh_product_3
			Call vehicle_record.veh_product_3.SetDbValue(Rs, vehicle_record.veh_product_3.CurrentValue, Null, vehicle_record.veh_product_3.ReadOnly)

			' Field veh_product_4
			Call vehicle_record.veh_product_4.SetDbValue(Rs, vehicle_record.veh_product_4.CurrentValue, Null, vehicle_record.veh_product_4.ReadOnly)

			' Field veh_product_5
			Call vehicle_record.veh_product_5.SetDbValue(Rs, vehicle_record.veh_product_5.CurrentValue, Null, vehicle_record.veh_product_5.ReadOnly)

			' Field veh_product_6
			Call vehicle_record.veh_product_6.SetDbValue(Rs, vehicle_record.veh_product_6.CurrentValue, Null, vehicle_record.veh_product_6.ReadOnly)

			' Field veh_product_7
			Call vehicle_record.veh_product_7.SetDbValue(Rs, vehicle_record.veh_product_7.CurrentValue, Null, vehicle_record.veh_product_7.ReadOnly)

			' Field veh_product_8
			Call vehicle_record.veh_product_8.SetDbValue(Rs, vehicle_record.veh_product_8.CurrentValue, Null, vehicle_record.veh_product_8.ReadOnly)

			' Field veh_domes_1
			Call vehicle_record.veh_domes_1.SetDbValue(Rs, vehicle_record.veh_domes_1.CurrentValue, Null, vehicle_record.veh_domes_1.ReadOnly)

			' Field veh_domes_2
			Call vehicle_record.veh_domes_2.SetDbValue(Rs, vehicle_record.veh_domes_2.CurrentValue, Null, vehicle_record.veh_domes_2.ReadOnly)

			' Field veh_domes_3
			Call vehicle_record.veh_domes_3.SetDbValue(Rs, vehicle_record.veh_domes_3.CurrentValue, Null, vehicle_record.veh_domes_3.ReadOnly)

			' Field veh_domes_4
			Call vehicle_record.veh_domes_4.SetDbValue(Rs, vehicle_record.veh_domes_4.CurrentValue, Null, vehicle_record.veh_domes_4.ReadOnly)

			' Field veh_domes_5
			Call vehicle_record.veh_domes_5.SetDbValue(Rs, vehicle_record.veh_domes_5.CurrentValue, Null, vehicle_record.veh_domes_5.ReadOnly)

			' Field veh_domes_6
			Call vehicle_record.veh_domes_6.SetDbValue(Rs, vehicle_record.veh_domes_6.CurrentValue, Null, vehicle_record.veh_domes_6.ReadOnly)

			' Field veh_domes_7
			Call vehicle_record.veh_domes_7.SetDbValue(Rs, vehicle_record.veh_domes_7.CurrentValue, Null, vehicle_record.veh_domes_7.ReadOnly)

			' Field veh_domes_8
			Call vehicle_record.veh_domes_8.SetDbValue(Rs, vehicle_record.veh_domes_8.CurrentValue, Null, vehicle_record.veh_domes_8.ReadOnly)

			' Field veh_export_1
			Call vehicle_record.veh_export_1.SetDbValue(Rs, vehicle_record.veh_export_1.CurrentValue, Null, vehicle_record.veh_export_1.ReadOnly)

			' Field veh_export_2
			Call vehicle_record.veh_export_2.SetDbValue(Rs, vehicle_record.veh_export_2.CurrentValue, Null, vehicle_record.veh_export_2.ReadOnly)

			' Field veh_export_3
			Call vehicle_record.veh_export_3.SetDbValue(Rs, vehicle_record.veh_export_3.CurrentValue, Null, vehicle_record.veh_export_3.ReadOnly)

			' Field veh_export_4
			Call vehicle_record.veh_export_4.SetDbValue(Rs, vehicle_record.veh_export_4.CurrentValue, Null, vehicle_record.veh_export_4.ReadOnly)

			' Field veh_export_5
			Call vehicle_record.veh_export_5.SetDbValue(Rs, vehicle_record.veh_export_5.CurrentValue, Null, vehicle_record.veh_export_5.ReadOnly)

			' Field veh_export_6
			Call vehicle_record.veh_export_6.SetDbValue(Rs, vehicle_record.veh_export_6.CurrentValue, Null, vehicle_record.veh_export_6.ReadOnly)

			' Field veh_export_7
			Call vehicle_record.veh_export_7.SetDbValue(Rs, vehicle_record.veh_export_7.CurrentValue, Null, vehicle_record.veh_export_7.ReadOnly)

			' Field veh_export_8
			Call vehicle_record.veh_export_8.SetDbValue(Rs, vehicle_record.veh_export_8.CurrentValue, Null, vehicle_record.veh_export_8.ReadOnly)

			' Field veh_remark
			Call vehicle_record.veh_remark.SetDbValue(Rs, vehicle_record.veh_remark.CurrentValue, Null, vehicle_record.veh_remark.ReadOnly)

			' Field veh_month_title
			Call vehicle_record.veh_month_title.SetDbValue(Rs, vehicle_record.veh_month_title.CurrentValue, Null, vehicle_record.veh_month_title.ReadOnly)

			' Field veh_range
			Call vehicle_record.veh_range.SetDbValue(Rs, vehicle_record.veh_range.CurrentValue, Null, vehicle_record.veh_range.ReadOnly)

			' Field veh_month_title2
			Call vehicle_record.veh_month_title2.SetDbValue(Rs, vehicle_record.veh_month_title2.CurrentValue, Null, vehicle_record.veh_month_title2.ReadOnly)

			' Field veh_range2
			Call vehicle_record.veh_range2.SetDbValue(Rs, vehicle_record.veh_range2.CurrentValue, Null, vehicle_record.veh_range2.ReadOnly)
			...
			bUpdateRow = vehicle_record.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call vehicle_record.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
