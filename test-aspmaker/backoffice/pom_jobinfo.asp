...
' ASPMaker configuration for Table job
Dim job
...
Class cjob
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_joblist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_joblist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_jobview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_jobview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_jobedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_jobadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_jobdelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [job] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get job_id()
		If Not IsObject(m_job_id) Then
			Set m_job_id = NewFldObj("job", "job", "x_job_id", "job_id", "[job_id]", "[job_id]", 3, 0, "[job_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get company_id()
		If Not IsObject(m_company_id) Then
			Set m_company_id = NewFldObj("job", "job", "x_company_id", "company_id", "[company_id]", "[company_id]", 3, 0, "[company_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get job_date()
		If Not IsObject(m_job_date) Then
			Set m_job_date = NewFldObj("job", "job", "x_job_date", "job_date", "[job_date]", "FORMAT([job_date], '')", 135, 8, "[job_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_title()
		If Not IsObject(m_job_title) Then
			Set m_job_title = NewFldObj("job", "job", "x_job_title", "job_title", "[job_title]", "[job_title]", 202, 0, "[job_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_intro()
		If Not IsObject(m_job_intro) Then
			Set m_job_intro = NewFldObj("job", "job", "x_job_intro", "job_intro", "[job_intro]", "[job_intro]", 203, 0, "[job_intro]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_detail()
		If Not IsObject(m_job_detail) Then
			Set m_job_detail = NewFldObj("job", "job", "x_job_detail", "job_detail", "[job_detail]", "[job_detail]", 203, 0, "[job_detail]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_create()
		If Not IsObject(m_job_create) Then
			Set m_job_create = NewFldObj("job", "job", "x_job_create", "job_create", "[job_create]", "[job_create]", 202, 0, "[job_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_update()
		If Not IsObject(m_job_update) Then
			Set m_job_update = NewFldObj("job", "job", "x_job_update", "job_update", "[job_update]", "[job_update]", 202, 0, "[job_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_show()
		If Not IsObject(m_job_show) Then
			Set m_job_show = NewFldObj("job", "job", "x_job_show", "job_show", "[job_show]", "[job_show]", 202, 0, "[job_show]", False, False, FALSE, "FORMATTED TEXT")
		End If
