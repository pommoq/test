...
' ASPMaker configuration for Table news_pdf_file
Dim news_pdf_file

' Define table class
Class cnews_pdf_file
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "news_pdf_file_1", news_pdf_file_1)
	...
	Public Property Get HighlightName()
		HighlightName = "news_pdf_file_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [news_pdf_file]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_news_pdf_filelist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_news_pdf_filelist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_news_pdf_fileview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_news_pdf_fileview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_news_pdf_fileedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_news_pdf_fileadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_news_pdf_filedelete.asp", UrlParm(""))
	End Function
	...
	Public Sub LoadListRowValues(RsRow)
		...
		news_pdf_file_1.DbValue = RsRow("news_pdf_file")
	...
	Sub RenderListRow()
		...
		' news_pdf_file
		news_pdf_file_1.ViewValue = news_pdf_file_1.CurrentValue
		news_pdf_file_1.ViewCustomAttributes = ""
		...
		' news_pdf_file
		news_pdf_file_1.LinkCustomAttributes = ""
		news_pdf_file_1.HrefValue = ""
		news_pdf_file_1.TooltipValue = ""
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [news_pdf_file] WHERE " & sWhereList
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("news_pdf_file_1", news_pdf_file_1.ExportValue(Export))
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				...
				If news_pdf_file_1.Exportable Then Call Doc.ExportCaption(news_pdf_file_1)
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					If news_pdf_file_1.Exportable Then Call Doc.ExportField(news_pdf_file_1)
...
'			End If
	...
	Public Property Get news_pdf_id()
		If Not IsObject(m_news_pdf_id) Then
			Set m_news_pdf_id = NewFldObj("news_pdf_file", "news_pdf_file", "x_news_pdf_id", "news_pdf_id", "[news_pdf_id]", "[news_pdf_id]", 3, 0, "[news_pdf_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get news_id()
		If Not IsObject(m_news_id) Then
			Set m_news_id = NewFldObj("news_pdf_file", "news_pdf_file", "x_news_id", "news_id", "[news_id]", "[news_id]", 3, 0, "[news_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	' Field news_pdf_file
	Private m_news_pdf_file_1

	Public Property Get news_pdf_file_1()
		If Not IsObject(m_news_pdf_file_1) Then
			Set m_news_pdf_file_1 = NewFldObj("news_pdf_file", "news_pdf_file", "x_news_pdf_file_1", "news_pdf_file", "[news_pdf_file]", "[news_pdf_file]", 202, 0, "[news_pdf_file]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set news_pdf_file_1 = m_news_pdf_file_1
	End Property
	...
	Public Property Get news_pdf_title()
		If Not IsObject(m_news_pdf_title) Then
			Set m_news_pdf_title = NewFldObj("news_pdf_file", "news_pdf_file", "x_news_pdf_title", "news_pdf_title", "[news_pdf_title]", "[news_pdf_title]", 202, 0, "[news_pdf_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_news_pdf_file_1) Then Set m_news_pdf_file_1 = Nothing
