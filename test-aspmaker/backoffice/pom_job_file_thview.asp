...
' Define page object
Dim job_file_th_view
Set job_file_th_view = New cjob_file_th_view
Set Page = job_file_th_view

' Page init processing
job_file_th_view.Page_Init()

' Page main processing
job_file_th_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
job_file_th_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If job_file_th.Export = "" Then %>
<script type="text/javascript">
// Page object
var job_file_th_view = new ew_Page("job_file_th_view");
job_file_th_view.PageID = "view"; // Page ID
var EW_PAGE_ID = job_file_th_view.PageID; // For backward compatibility
// Form object
var fjob_file_thview = new ew_Form("fjob_file_thview");
// Form_CustomValidate event
fjob_file_thview.Form_CustomValidate = 
...
fjob_file_thview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fjob_file_thview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% job_file_th_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not job_file_th_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	job_file_th_view.ActionOptions.Render "body", "", "", "", "", ""
	job_file_th_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% job_file_th_view.ShowPageHeader() %>
<% job_file_th_view.ShowMessage %>
<form name="fjob_file_thview" id="fjob_file_thview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="job_file_th">
<table class="ewGrid"><tr><td>
<table id="tbl_job_file_thview" class="table table-bordered table-striped">
...
<%= job_file_th.job_file_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= job_file_th.job_file_name.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= job_file_th.job_file_title.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fjob_file_thview.Init();
</script>
<%
job_file_th_view.ShowPageFooter()
...
Class cjob_file_th_view
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_job_file_thlist.asp" ' Return to list
			End If

			' Get action
			job_file_th.CurrentAction = "I" ' Display form
			Select Case job_file_th.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_job_file_thlist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_job_file_thlist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		job_file_th.RowType = EW_ROWTYPE_VIEW
