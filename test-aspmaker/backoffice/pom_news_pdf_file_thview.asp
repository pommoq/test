...
' Define page object
Dim news_pdf_file_th_view
Set news_pdf_file_th_view = New cnews_pdf_file_th_view
Set Page = news_pdf_file_th_view

' Page init processing
news_pdf_file_th_view.Page_Init()

' Page main processing
news_pdf_file_th_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
news_pdf_file_th_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If news_pdf_file_th.Export = "" Then %>
<script type="text/javascript">
// Page object
var news_pdf_file_th_view = new ew_Page("news_pdf_file_th_view");
news_pdf_file_th_view.PageID = "view"; // Page ID
var EW_PAGE_ID = news_pdf_file_th_view.PageID; // For backward compatibility
// Form object
var fnews_pdf_file_thview = new ew_Form("fnews_pdf_file_thview");
// Form_CustomValidate event
fnews_pdf_file_thview.Form_CustomValidate = 
...
fnews_pdf_file_thview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fnews_pdf_file_thview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% news_pdf_file_th_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not news_pdf_file_th_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	news_pdf_file_th_view.ActionOptions.Render "body", "", "", "", "", ""
	news_pdf_file_th_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% news_pdf_file_th_view.ShowPageHeader() %>
<% news_pdf_file_th_view.ShowMessage %>
<form name="fnews_pdf_file_thview" id="fnews_pdf_file_thview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="news_pdf_file_th">
<table class="ewGrid"><tr><td>
<table id="tbl_news_pdf_file_thview" class="table table-bordered table-striped">
...
<%= news_pdf_file_th.news_pdf_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= news_pdf_file_th.news_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= news_pdf_file_th.news_pdf_file.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= news_pdf_file_th.news_pdf_title.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fnews_pdf_file_thview.Init();
</script>
<%
news_pdf_file_th_view.ShowPageFooter()
...
' Drop page object
Set news_pdf_file_th_view = Nothing
%>
<%
...
Class cnews_pdf_file_th_view
	...
	Public Property Get PageObjName()
		PageObjName = "news_pdf_file_th_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_news_pdf_file_thlist.asp" ' Return to list
			End If

			' Get action
			news_pdf_file_th.CurrentAction = "I" ' Display form
			Select Case news_pdf_file_th.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_news_pdf_file_thlist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_news_pdf_file_thlist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		news_pdf_file_th.RowType = EW_ROWTYPE_VIEW
