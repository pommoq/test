...
' ASPMaker configuration for Table job_file
Dim job_file
...
Class cjob_file
	...
	Public Property Get HighlightName()
		HighlightName = "job_file_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [job_file]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_job_filelist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_job_filelist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_job_fileview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_job_fileview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_job_fileedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_job_fileadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_job_filedelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [job_file] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get job_file_id()
		If Not IsObject(m_job_file_id) Then
			Set m_job_file_id = NewFldObj("job_file", "job_file", "x_job_file_id", "job_file_id", "[job_file_id]", "[job_file_id]", 3, 0, "[job_file_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get job_id()
		If Not IsObject(m_job_id) Then
			Set m_job_id = NewFldObj("job_file", "job_file", "x_job_id", "job_id", "[job_id]", "[job_id]", 3, 0, "[job_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get job_file_name()
		If Not IsObject(m_job_file_name) Then
			Set m_job_file_name = NewFldObj("job_file", "job_file", "x_job_file_name", "job_file_name", "[job_file_name]", "[job_file_name]", 202, 0, "[job_file_name]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get job_file_title()
		If Not IsObject(m_job_file_title) Then
			Set m_job_file_title = NewFldObj("job_file", "job_file", "x_job_file_title", "job_file_title", "[job_file_title]", "[job_file_title]", 202, 0, "[job_file_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
