...
' ASPMaker configuration for Table eventcalendar_pdf_file_th
Dim eventcalendar_pdf_file_th

' Define table class
Class ceventcalendar_pdf_file_th
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "eventcalendar_pdf_id", eventcalendar_pdf_id)
		Call ew_SetArObj(Fields, "eventcalendar_id", eventcalendar_id)
		Call ew_SetArObj(Fields, "eventcalendar_pdf_file", eventcalendar_pdf_file)
		Call ew_SetArObj(Fields, "eventcalendar_pdf_title", eventcalendar_pdf_title)
	End Sub
	...
	Public Property Get TableVar()
		TableVar = "eventcalendar_pdf_file_th"
	End Property
	...
	Public Property Get HighlightName()
		HighlightName = "eventcalendar_pdf_file_th_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [eventcalendar_pdf_file_th]"
	End Property
	...
	Private Property Get SqlKeyFilter()
		SqlKeyFilter = "[eventcalendar_pdf_id] = @eventcalendar_pdf_id@"
	End Property
	...
	Public Property Get KeyFilter()
		...
		If Not IsNumeric(eventcalendar_pdf_id.CurrentValue) Then
			sKeyFilter = "0=1" ' Invalid key
		End If
		sKeyFilter = Replace(sKeyFilter, "@eventcalendar_pdf_id@", ew_AdjustSql(eventcalendar_pdf_id.CurrentValue)) ' Replace key value
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_eventcalendar_pdf_file_thlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_eventcalendar_pdf_file_thlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_eventcalendar_pdf_file_thview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_eventcalendar_pdf_file_thview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_eventcalendar_pdf_file_thedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_eventcalendar_pdf_file_thadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_eventcalendar_pdf_file_thdelete.asp", UrlParm(""))
	End Function
	...
	Public Function KeyUrl(url, parm)
		...
		If Not IsNull(eventcalendar_pdf_id.CurrentValue) Then
			sUrl = sUrl & "eventcalendar_pdf_id=" & eventcalendar_pdf_id.CurrentValue
		Else
	...
	Function UrlParm(parm)
		If UseTokenInUrl Then
			UrlParm = "t=eventcalendar_pdf_file_th"
		Else
			UrlParm = ""
		End If
		If parm <> "" Then
	...
	Public Function GetRecordKeys()
		...
		If Not bHasKey Then
			...
			ElseIf Request.QueryString <> "" Then
				ReDim arKeys(0)
				arKeys(0) = Request.QueryString("eventcalendar_pdf_id") ' eventcalendar_pdf_id
	...
	Public Function GetKeyFilter()
		...
		If IsArray(arKeys) Then
			For i = 0 to UBound(arKeys)
				...
				eventcalendar_pdf_id.CurrentValue = key
	...
	Public Sub LoadListRowValues(RsRow)
		eventcalendar_pdf_id.DbValue = RsRow("eventcalendar_pdf_id")
		eventcalendar_id.DbValue = RsRow("eventcalendar_id")
		eventcalendar_pdf_file.DbValue = RsRow("eventcalendar_pdf_file")
		eventcalendar_pdf_title.DbValue = RsRow("eventcalendar_pdf_title")
	End Sub
	...
	Sub RenderListRow()
		...
		eventcalendar_pdf_id.ViewValue = eventcalendar_pdf_id.CurrentValue
		eventcalendar_pdf_id.ViewCustomAttributes = ""
		...
		' eventcalendar_pdf_file
		eventcalendar_pdf_file.ViewValue = eventcalendar_pdf_file.CurrentValue
		eventcalendar_pdf_file.ViewCustomAttributes = ""

		' eventcalendar_pdf_title
		eventcalendar_pdf_title.ViewValue = eventcalendar_pdf_title.CurrentValue
		eventcalendar_pdf_title.ViewCustomAttributes = ""

		' eventcalendar_pdf_id
		eventcalendar_pdf_id.LinkCustomAttributes = ""
		eventcalendar_pdf_id.HrefValue = ""
		eventcalendar_pdf_id.TooltipValue = ""
		...
		' eventcalendar_pdf_file
		eventcalendar_pdf_file.LinkCustomAttributes = ""
		eventcalendar_pdf_file.HrefValue = ""
		eventcalendar_pdf_file.TooltipValue = ""

		' eventcalendar_pdf_title
		eventcalendar_pdf_title.LinkCustomAttributes = ""
		eventcalendar_pdf_title.HrefValue = ""
		eventcalendar_pdf_title.TooltipValue = ""
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [eventcalendar_pdf_file_th] WHERE " & sWhereList
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					Call XmlDoc.AddField("eventcalendar_pdf_id", eventcalendar_pdf_id.ExportValue(Export))
					Call XmlDoc.AddField("eventcalendar_id", eventcalendar_id.ExportValue(Export))
					Call XmlDoc.AddField("eventcalendar_pdf_file", eventcalendar_pdf_file.ExportValue(Export))
					Call XmlDoc.AddField("eventcalendar_pdf_title", eventcalendar_pdf_title.ExportValue(Export))
				Else
					Call XmlDoc.AddField("eventcalendar_pdf_id", eventcalendar_pdf_id.ExportValue(Export))
					Call XmlDoc.AddField("eventcalendar_id", eventcalendar_id.ExportValue(Export))
					Call XmlDoc.AddField("eventcalendar_pdf_file", eventcalendar_pdf_file.ExportValue(Export))
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				If eventcalendar_pdf_id.Exportable Then Call Doc.ExportCaption(eventcalendar_pdf_id)
				If eventcalendar_id.Exportable Then Call Doc.ExportCaption(eventcalendar_id)
				If eventcalendar_pdf_file.Exportable Then Call Doc.ExportCaption(eventcalendar_pdf_file)
				If eventcalendar_pdf_title.Exportable Then Call Doc.ExportCaption(eventcalendar_pdf_title)
			Else
				If eventcalendar_pdf_id.Exportable Then Call Doc.ExportCaption(eventcalendar_pdf_id)
				If eventcalendar_id.Exportable Then Call Doc.ExportCaption(eventcalendar_id)
				If eventcalendar_pdf_file.Exportable Then Call Doc.ExportCaption(eventcalendar_pdf_file)
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					If eventcalendar_pdf_id.Exportable Then Call Doc.ExportField(eventcalendar_pdf_id)
					If eventcalendar_id.Exportable Then Call Doc.ExportField(eventcalendar_id)
					If eventcalendar_pdf_file.Exportable Then Call Doc.ExportField(eventcalendar_pdf_file)
					If eventcalendar_pdf_title.Exportable Then Call Doc.ExportField(eventcalendar_pdf_title)
				Else
					If eventcalendar_pdf_id.Exportable Then Call Doc.ExportField(eventcalendar_pdf_id)
					If eventcalendar_id.Exportable Then Call Doc.ExportField(eventcalendar_id)
					If eventcalendar_pdf_file.Exportable Then Call Doc.ExportField(eventcalendar_pdf_file)
...
'			End If
	...
	Private m_eventcalendar_pdf_id

	Public Property Get eventcalendar_pdf_id()
		If Not IsObject(m_eventcalendar_pdf_id) Then
			Set m_eventcalendar_pdf_id = NewFldObj("eventcalendar_pdf_file_th", "eventcalendar_pdf_file_th", "x_eventcalendar_pdf_id", "eventcalendar_pdf_id", "[eventcalendar_pdf_id]", "[eventcalendar_pdf_id]", 3, 0, "[eventcalendar_pdf_id]", False, False, FALSE, "FORMATTED TEXT")
			m_eventcalendar_pdf_id.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set eventcalendar_pdf_id = m_eventcalendar_pdf_id
	End Property
	...
	Public Property Get eventcalendar_id()
		If Not IsObject(m_eventcalendar_id) Then
			Set m_eventcalendar_id = NewFldObj("eventcalendar_pdf_file_th", "eventcalendar_pdf_file_th", "x_eventcalendar_id", "eventcalendar_id", "[eventcalendar_id]", "[eventcalendar_id]", 3, 0, "[eventcalendar_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_eventcalendar_pdf_file

	Public Property Get eventcalendar_pdf_file()
		If Not IsObject(m_eventcalendar_pdf_file) Then
			Set m_eventcalendar_pdf_file = NewFldObj("eventcalendar_pdf_file_th", "eventcalendar_pdf_file_th", "x_eventcalendar_pdf_file", "eventcalendar_pdf_file", "[eventcalendar_pdf_file]", "[eventcalendar_pdf_file]", 202, 0, "[eventcalendar_pdf_file]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set eventcalendar_pdf_file = m_eventcalendar_pdf_file
	End Property

	' Field eventcalendar_pdf_title
	Private m_eventcalendar_pdf_title

	Public Property Get eventcalendar_pdf_title()
		If Not IsObject(m_eventcalendar_pdf_title) Then
			Set m_eventcalendar_pdf_title = NewFldObj("eventcalendar_pdf_file_th", "eventcalendar_pdf_file_th", "x_eventcalendar_pdf_title", "eventcalendar_pdf_title", "[eventcalendar_pdf_title]", "[eventcalendar_pdf_title]", 202, 0, "[eventcalendar_pdf_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set eventcalendar_pdf_title = m_eventcalendar_pdf_title
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		If IsObject(m_eventcalendar_pdf_id) Then Set m_eventcalendar_pdf_id = Nothing
		If IsObject(m_eventcalendar_id) Then Set m_eventcalendar_id = Nothing
		If IsObject(m_eventcalendar_pdf_file) Then Set m_eventcalendar_pdf_file = Nothing
		If IsObject(m_eventcalendar_pdf_title) Then Set m_eventcalendar_pdf_title = Nothing
