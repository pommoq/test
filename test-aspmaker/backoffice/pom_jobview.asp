...
job_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If job.Export = "" Then %>
<script type="text/javascript">
// Page object
var job_view = new ew_Page("job_view");
job_view.PageID = "view"; // Page ID
var EW_PAGE_ID = job_view.PageID; // For backward compatibility
// Form object
var fjobview = new ew_Form("fjobview");
// Form_CustomValidate event
fjobview.Form_CustomValidate = 
...
fjobview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fjobview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% job_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not job_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	job_view.ActionOptions.Render "body", "", "", "", "", ""
	job_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% job_view.ShowPageHeader() %>
<% job_view.ShowMessage %>
<form name="fjobview" id="fjobview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="job">
<table class="ewGrid"><tr><td>
<table id="tbl_jobview" class="table table-bordered table-striped">
...
<span<%= job.job_intro.ViewAttributes %>>
<%= job.job_intro.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<span<%= job.job_detail.ViewAttributes %>>
<%= job.job_detail.ViewValue %>
</span>
</span>
</td>
	</tr>
...
Class cjob_view
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_joblist.asp" ' Return to list
			End If

			' Get action
			job.CurrentAction = "I" ' Display form
			Select Case job.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_joblist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_joblist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		job.RowType = EW_ROWTYPE_VIEW
		Call job.ResetAttrs()
		Call RenderRow()
	End Sub
