...
' ASPMaker configuration for Table banner_th
Dim banner_th
...
Class cbanner_th
	...
	Public Property Get HighlightName()
		HighlightName = "banner_th_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [banner_th]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_banner_thlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_banner_thlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_banner_thview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_banner_thview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_banner_thedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_banner_thadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_banner_thdelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [banner_th] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get banner_id()
		If Not IsObject(m_banner_id) Then
			Set m_banner_id = NewFldObj("banner_th", "banner_th", "x_banner_id", "banner_id", "[banner_id]", "[banner_id]", 3, 0, "[banner_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get banner_img()
		If Not IsObject(m_banner_img) Then
			Set m_banner_img = NewFldObj("banner_th", "banner_th", "x_banner_img", "banner_img", "[banner_img]", "[banner_img]", 202, 0, "[banner_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get banner_link()
		If Not IsObject(m_banner_link) Then
			Set m_banner_link = NewFldObj("banner_th", "banner_th", "x_banner_link", "banner_link", "[banner_link]", "[banner_link]", 202, 0, "[banner_link]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get banner_sort()
		If Not IsObject(m_banner_sort) Then
			Set m_banner_sort = NewFldObj("banner_th", "banner_th", "x_banner_sort", "banner_sort", "[banner_sort]", "[banner_sort]", 3, 0, "[banner_sort]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get start_date()
		If Not IsObject(m_start_date) Then
			Set m_start_date = NewFldObj("banner_th", "banner_th", "x_start_date", "start_date", "[start_date]", "FORMAT([start_date], '')", 135, 8, "[start_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get end_date()
		If Not IsObject(m_end_date) Then
			Set m_end_date = NewFldObj("banner_th", "banner_th", "x_end_date", "end_date", "[end_date]", "FORMAT([end_date], '')", 135, 8, "[end_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
