...
' Define page object
Dim e_library_view
Set e_library_view = New ce_library_view
Set Page = e_library_view

' Page init processing
e_library_view.Page_Init()

' Page main processing
e_library_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
e_library_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If e_library.Export = "" Then %>
<script type="text/javascript">
// Page object
var e_library_view = new ew_Page("e_library_view");
e_library_view.PageID = "view"; // Page ID
var EW_PAGE_ID = e_library_view.PageID; // For backward compatibility
// Form object
var fe_libraryview = new ew_Form("fe_libraryview");
// Form_CustomValidate event
fe_libraryview.Form_CustomValidate = 
...
fe_libraryview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fe_libraryview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% e_library_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not e_library_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	e_library_view.ActionOptions.Render "body", "", "", "", "", ""
	e_library_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% e_library_view.ShowPageHeader() %>
<% e_library_view.ShowMessage %>
<form name="fe_libraryview" id="fe_libraryview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="e_library">
<table class="ewGrid"><tr><td>
<table id="tbl_e_libraryview" class="table table-bordered table-striped">
...
<span<%= e_library.el_detail.ViewAttributes %>>
<%= e_library.el_detail.ViewValue %>
</span>
</span>
</td>
	</tr>
...
Class ce_library_view
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_e_librarylist.asp" ' Return to list
			End If

			' Get action
			e_library.CurrentAction = "I" ' Display form
			Select Case e_library.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_e_librarylist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_e_librarylist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		e_library.RowType = EW_ROWTYPE_VIEW
