...
' Define page object
Dim vehicle_record_th_view
Set vehicle_record_th_view = New cvehicle_record_th_view
Set Page = vehicle_record_th_view

' Page init processing
vehicle_record_th_view.Page_Init()

' Page main processing
vehicle_record_th_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
vehicle_record_th_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If vehicle_record_th.Export = "" Then %>
<script type="text/javascript">
// Page object
var vehicle_record_th_view = new ew_Page("vehicle_record_th_view");
vehicle_record_th_view.PageID = "view"; // Page ID
var EW_PAGE_ID = vehicle_record_th_view.PageID; // For backward compatibility
// Form object
var fvehicle_record_thview = new ew_Form("fvehicle_record_thview");
// Form_CustomValidate event
fvehicle_record_thview.Form_CustomValidate = 
...
fvehicle_record_thview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fvehicle_record_thview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% vehicle_record_th_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not vehicle_record_th_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	vehicle_record_th_view.ActionOptions.Render "body", "", "", "", "", ""
	vehicle_record_th_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% vehicle_record_th_view.ShowPageHeader() %>
<% vehicle_record_th_view.ShowMessage %>
<form name="fvehicle_record_thview" id="fvehicle_record_thview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="vehicle_record_th">
<table class="ewGrid"><tr><td>
<table id="tbl_vehicle_record_thview" class="table table-bordered table-striped">
...
<%= vehicle_record_th.veh_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.vch_month.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.vch_year.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_1.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_2.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_3.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_4.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_5.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_6.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_7.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_product_8.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_1.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_2.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_3.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_4.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_5.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_6.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_7.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_domes_8.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_1.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_2.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_3.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_4.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_5.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_6.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_7.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_export_8.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<span<%= vehicle_record_th.veh_remark.ViewAttributes %>>
<%= vehicle_record_th.veh_remark.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_month_title.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_range.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_month_title2.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= vehicle_record_th.veh_range2.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fvehicle_record_thview.Init();
</script>
<%
vehicle_record_th_view.ShowPageFooter()
...
' Drop page object
Set vehicle_record_th_view = Nothing
%>
<%
...
Class cvehicle_record_th_view
	...
	Public Property Get PageObjName()
		PageObjName = "vehicle_record_th_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_vehicle_record_thlist.asp" ' Return to list
			End If

			' Get action
			vehicle_record_th.CurrentAction = "I" ' Display form
			Select Case vehicle_record_th.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_vehicle_record_thlist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_vehicle_record_thlist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		vehicle_record_th.RowType = EW_ROWTYPE_VIEW
