...
' Define page object
Dim eventcalendar_pdf_file_view
Set eventcalendar_pdf_file_view = New ceventcalendar_pdf_file_view
Set Page = eventcalendar_pdf_file_view

' Page init processing
eventcalendar_pdf_file_view.Page_Init()

' Page main processing
eventcalendar_pdf_file_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
eventcalendar_pdf_file_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If eventcalendar_pdf_file.Export = "" Then %>
<script type="text/javascript">
// Page object
var eventcalendar_pdf_file_view = new ew_Page("eventcalendar_pdf_file_view");
eventcalendar_pdf_file_view.PageID = "view"; // Page ID
var EW_PAGE_ID = eventcalendar_pdf_file_view.PageID; // For backward compatibility
// Form object
var feventcalendar_pdf_fileview = new ew_Form("feventcalendar_pdf_fileview");
// Form_CustomValidate event
feventcalendar_pdf_fileview.Form_CustomValidate = 
...
feventcalendar_pdf_fileview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
feventcalendar_pdf_fileview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% eventcalendar_pdf_file_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not eventcalendar_pdf_file_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	eventcalendar_pdf_file_view.ActionOptions.Render "body", "", "", "", "", ""
	eventcalendar_pdf_file_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% eventcalendar_pdf_file_view.ShowPageHeader() %>
<% eventcalendar_pdf_file_view.ShowMessage %>
<form name="feventcalendar_pdf_fileview" id="feventcalendar_pdf_fileview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="eventcalendar_pdf_file">
<table class="ewGrid"><tr><td>
<table id="tbl_eventcalendar_pdf_fileview" class="table table-bordered table-striped">
...
<%= eventcalendar_pdf_file.eventcalendar_pdf_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= eventcalendar_pdf_file.eventcalendar_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= eventcalendar_pdf_file.eventcalendar_pdf_file_1.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= eventcalendar_pdf_file.eventcalendar_pdf_title.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
feventcalendar_pdf_fileview.Init();
</script>
<%
eventcalendar_pdf_file_view.ShowPageFooter()
...
' Drop page object
Set eventcalendar_pdf_file_view = Nothing
%>
<%
...
' Page Class
'
Class ceventcalendar_pdf_file_view
	...
	Public Property Get PageObjName()
		PageObjName = "eventcalendar_pdf_file_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_eventcalendar_pdf_filelist.asp" ' Return to list
			End If

			' Get action
			eventcalendar_pdf_file.CurrentAction = "I" ' Display form
			Select Case eventcalendar_pdf_file.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_eventcalendar_pdf_filelist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_eventcalendar_pdf_filelist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		eventcalendar_pdf_file.RowType = EW_ROWTYPE_VIEW
