...
' Define page object
Dim banner_logo_01_th_view
Set banner_logo_01_th_view = New cbanner_logo_01_th_view
Set Page = banner_logo_01_th_view

' Page init processing
banner_logo_01_th_view.Page_Init()

' Page main processing
banner_logo_01_th_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
banner_logo_01_th_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If banner_logo_01_th.Export = "" Then %>
<script type="text/javascript">
// Page object
var banner_logo_01_th_view = new ew_Page("banner_logo_01_th_view");
banner_logo_01_th_view.PageID = "view"; // Page ID
var EW_PAGE_ID = banner_logo_01_th_view.PageID; // For backward compatibility
// Form object
var fbanner_logo_01_thview = new ew_Form("fbanner_logo_01_thview");
// Form_CustomValidate event
fbanner_logo_01_thview.Form_CustomValidate = 
...
fbanner_logo_01_thview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fbanner_logo_01_thview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% banner_logo_01_th_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not banner_logo_01_th_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	banner_logo_01_th_view.ActionOptions.Render "body", "", "", "", "", ""
	banner_logo_01_th_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% banner_logo_01_th_view.ShowPageHeader() %>
<% banner_logo_01_th_view.ShowMessage %>
<form name="fbanner_logo_01_thview" id="fbanner_logo_01_thview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="banner_logo_01_th">
<table class="ewGrid"><tr><td>
<table id="tbl_banner_logo_01_thview" class="table table-bordered table-striped">
...
<%= banner_logo_01_th.banner_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_01_th.banner_img.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_01_th.banner_link.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_01_th.banner_sort.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_01_th.start_date.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_01_th.end_date.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fbanner_logo_01_thview.Init();
</script>
<%
banner_logo_01_th_view.ShowPageFooter()
...
' Drop page object
Set banner_logo_01_th_view = Nothing
%>
<%
...
Class cbanner_logo_01_th_view
	...
	Public Property Get PageObjName()
		PageObjName = "banner_logo_01_th_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_banner_logo_01_thlist.asp" ' Return to list
			End If

			' Get action
			banner_logo_01_th.CurrentAction = "I" ' Display form
			Select Case banner_logo_01_th.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_banner_logo_01_thlist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_banner_logo_01_thlist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		banner_logo_01_th.RowType = EW_ROWTYPE_VIEW
