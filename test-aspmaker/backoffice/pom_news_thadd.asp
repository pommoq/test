...
' Define page object
Dim news_th_add
Set news_th_add = New cnews_th_add
Set Page = news_th_add

' Page init processing
news_th_add.Page_Init()

' Page main processing
news_th_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
news_th_add.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var news_th_add = new ew_Page("news_th_add");
news_th_add.PageID = "add"; // Page ID
var EW_PAGE_ID = news_th_add.PageID; // For backward compatibility
// Form object
var fnews_thadd = new ew_Form("fnews_thadd");
// Validate form
fnews_thadd.Validate = function() {
...
fnews_thadd.Form_CustomValidate = 
...
fnews_thadd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fnews_thadd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% news_th_add.ShowPageHeader() %>
<% news_th_add.ShowMessage %>
<form name="fnews_thadd" id="fnews_thadd" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="news_th">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_news_thadd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_news_id" name="x_news_id" id="x_news_id" size="30" placeholder="<%= news_th.news_id.PlaceHolder %>" value="<%= news_th.news_id.EditValue %>"<%= news_th.news_id.EditAttributes %>>
</span>
...
Class cnews_th_add
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			news_th.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("news_id").Count > 0 Then
				...
				Call news_th.SetKey("news_id", news_th.news_id.CurrentValue) ' Set up key
			Else
				Call news_th.SetKey("news_id", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
				news_th.CurrentAction = "C" ' Copy Record
			Else
				news_th.CurrentAction = "I" ' Display Blank Record
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			If Not ValidateForm() Then
				news_th.CurrentAction = "I" ' Form error, reset action
		...
		Select Case news_th.CurrentAction
			...
			Case "A" ' Add new record
				news_th.SendEmail = True ' Send email on add success
				If AddRow(OldRecordset) Then ' Add successful
					SuccessMessage = Language.Phrase("AddSuccess") ' Set up success message
					Dim sReturnUrl
					sReturnUrl = news_th.ReturnUrl
					If ew_GetPageName(sReturnUrl) = "pom_news_thview.asp" Then sReturnUrl = news_th.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		news_th.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Function LoadDefaultValues()
		news_th.news_id.CurrentValue = Null
		news_th.news_id.OldValue = news_th.news_id.CurrentValue
		news_th.news_img.CurrentValue = Null
		news_th.news_img.OldValue = news_th.news_img.CurrentValue
		news_th.news_date.CurrentValue = Null
		news_th.news_date.OldValue = news_th.news_date.CurrentValue
		news_th.news_category.CurrentValue = Null
		news_th.news_category.OldValue = news_th.news_category.CurrentValue
		news_th.news_category_sub.CurrentValue = Null
		news_th.news_category_sub.OldValue = news_th.news_category_sub.CurrentValue
		news_th.start_date.CurrentValue = Null
		news_th.start_date.OldValue = news_th.start_date.CurrentValue
		news_th.end_date.CurrentValue = Null
		news_th.end_date.OldValue = news_th.end_date.CurrentValue
		news_th.news_pdf.CurrentValue = Null
		news_th.news_pdf.OldValue = news_th.news_pdf.CurrentValue
		news_th.news_subject.CurrentValue = Null
		news_th.news_subject.OldValue = news_th.news_subject.CurrentValue
		news_th.news_subject_th.CurrentValue = Null
		news_th.news_subject_th.OldValue = news_th.news_subject_th.CurrentValue
		news_th.news_intro.CurrentValue = Null
		news_th.news_intro.OldValue = news_th.news_intro.CurrentValue
		news_th.news_intro_th.CurrentValue = Null
		news_th.news_intro_th.OldValue = news_th.news_intro_th.CurrentValue
		news_th.news_content.CurrentValue = Null
		news_th.news_content.OldValue = news_th.news_content.CurrentValue
		news_th.news_content_th.CurrentValue = Null
		news_th.news_content_th.OldValue = news_th.news_content_th.CurrentValue
		news_th.news_show_en.CurrentValue = Null
		news_th.news_show_en.OldValue = news_th.news_show_en.CurrentValue
		news_th.news_show.CurrentValue = Null
		news_th.news_show.OldValue = news_th.news_show.CurrentValue
		news_th.news_show_home.CurrentValue = Null
		news_th.news_show_home.OldValue = news_th.news_show_home.CurrentValue
		news_th.news_create.CurrentValue = Null
		news_th.news_create.OldValue = news_th.news_create.CurrentValue
		news_th.news_update.CurrentValue = Null
		news_th.news_update.OldValue = news_th.news_update.CurrentValue
	End Function
	...
	Sub RenderRow()
		...
		ElseIf news_th.RowType = EW_ROWTYPE_ADD Then ' Add row

			' news_id
			news_th.news_id.EditCustomAttributes = ""
			news_th.news_id.EditValue = ew_HtmlEncode(news_th.news_id.CurrentValue)
			news_th.news_id.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(news_th.news_id.FldCaption))
	...
	Function AddRow(RsOld)
		...
		If news_th.news_id.CurrentValue <> "" Then ' Check field with unique index
			sFilter = "([news_id] = " & ew_AdjustSql(news_th.news_id.CurrentValue) & ")"
			Set RsChk = news_th.LoadRs(sFilter)
			If Not (RsChk Is Nothing) Then
				sIdxErrMsg = Replace(Language.Phrase("DupIndex"), "%f", news_th.news_id.FldCaption)
				sIdxErrMsg = Replace(sIdxErrMsg, "%v", news_th.news_id.CurrentValue)
		...
		' Field news_id
		Call news_th.news_id.SetDbValue(Rs, news_th.news_id.CurrentValue, Null, False)

		' Field news_img
		Call news_th.news_img.SetDbValue(Rs, news_th.news_img.CurrentValue, Null, False)

		' Field news_date
		Call news_th.news_date.SetDbValue(Rs, news_th.news_date.CurrentValue, Null, False)

		' Field news_category
		Call news_th.news_category.SetDbValue(Rs, news_th.news_category.CurrentValue, Null, False)

		' Field news_category_sub
		Call news_th.news_category_sub.SetDbValue(Rs, news_th.news_category_sub.CurrentValue, Null, False)

		' Field start_date
		Call news_th.start_date.SetDbValue(Rs, news_th.start_date.CurrentValue, Null, False)

		' Field end_date
		Call news_th.end_date.SetDbValue(Rs, news_th.end_date.CurrentValue, Null, False)

		' Field news_pdf
		Call news_th.news_pdf.SetDbValue(Rs, news_th.news_pdf.CurrentValue, Null, False)

		' Field news_subject
		Call news_th.news_subject.SetDbValue(Rs, news_th.news_subject.CurrentValue, Null, False)

		' Field news_subject_th
		Call news_th.news_subject_th.SetDbValue(Rs, news_th.news_subject_th.CurrentValue, Null, False)

		' Field news_intro
		Call news_th.news_intro.SetDbValue(Rs, news_th.news_intro.CurrentValue, Null, False)

		' Field news_intro_th
		Call news_th.news_intro_th.SetDbValue(Rs, news_th.news_intro_th.CurrentValue, Null, False)

		' Field news_content
		Call news_th.news_content.SetDbValue(Rs, news_th.news_content.CurrentValue, Null, False)

		' Field news_content_th
		Call news_th.news_content_th.SetDbValue(Rs, news_th.news_content_th.CurrentValue, Null, False)

		' Field news_show_en
		Call news_th.news_show_en.SetDbValue(Rs, news_th.news_show_en.CurrentValue, Null, False)

		' Field news_show
		Call news_th.news_show.SetDbValue(Rs, news_th.news_show.CurrentValue, Null, False)

		' Field news_show_home
		Call news_th.news_show_home.SetDbValue(Rs, news_th.news_show_home.CurrentValue, Null, False)

		' Field news_create
		Call news_th.news_create.SetDbValue(Rs, news_th.news_create.CurrentValue, Null, False)

		' Field news_update
		Call news_th.news_update.SetDbValue(Rs, news_th.news_update.CurrentValue, Null, False)
		...
		bInsertRow = news_th.Row_Inserting(RsOld, Rs)

		' Check if key value entered
		If bInsertRow And news_th.ValidateKey And news_th.news_id.CurrentValue = "" And news_th.news_id.SessionValue = "" Then
		...
		Dim sKeyErrMsg
		If bInsertRow And news_th.ValidateKey Then
			sFilter = news_th.KeyFilter
			Set RsChk = news_th.LoadRs(sFilter)
			If Not (RsChk Is Nothing) Then
		...
		If AddRow Then
			...
			Call news_th.Row_Inserted(RsOld, RsNew)
		End If
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(news_th.CurrentAction = "C", "Copy", "Add")
