...
' ASPMaker configuration for Table department_th
Dim department_th

' Define table class
Class cdepartment_th
	...
	Public Property Get HighlightName()
		HighlightName = "department_th_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [department_th]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_department_thlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_department_thlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_department_thview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_department_thview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_department_thedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_department_thadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_department_thdelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [department_th] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get dept_id()
		If Not IsObject(m_dept_id) Then
			Set m_dept_id = NewFldObj("department_th", "department_th", "x_dept_id", "dept_id", "[dept_id]", "[dept_id]", 3, 0, "[dept_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get office_id()
		If Not IsObject(m_office_id) Then
			Set m_office_id = NewFldObj("department_th", "department_th", "x_office_id", "office_id", "[office_id]", "[office_id]", 3, 0, "[office_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get dept_name()
		If Not IsObject(m_dept_name) Then
			Set m_dept_name = NewFldObj("department_th", "department_th", "x_dept_name", "dept_name", "[dept_name]", "[dept_name]", 202, 0, "[dept_name]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get dept_sort()
		If Not IsObject(m_dept_sort) Then
			Set m_dept_sort = NewFldObj("department_th", "department_th", "x_dept_sort", "dept_sort", "[dept_sort]", "[dept_sort]", 3, 0, "[dept_sort]", False, False, FALSE, "FORMATTED TEXT")
