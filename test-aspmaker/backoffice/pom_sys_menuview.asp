...
' Define page object
Dim sys_menu_view
Set sys_menu_view = New csys_menu_view
Set Page = sys_menu_view

' Page init processing
sys_menu_view.Page_Init()

' Page main processing
sys_menu_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
sys_menu_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If sys_menu.Export = "" Then %>
<script type="text/javascript">
// Page object
var sys_menu_view = new ew_Page("sys_menu_view");
sys_menu_view.PageID = "view"; // Page ID
var EW_PAGE_ID = sys_menu_view.PageID; // For backward compatibility
// Form object
var fsys_menuview = new ew_Form("fsys_menuview");
// Form_CustomValidate event
fsys_menuview.Form_CustomValidate = 
...
fsys_menuview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fsys_menuview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% sys_menu_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not sys_menu_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	sys_menu_view.ActionOptions.Render "body", "", "", "", "", ""
	sys_menu_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% sys_menu_view.ShowPageHeader() %>
<% sys_menu_view.ShowMessage %>
<form name="fsys_menuview" id="fsys_menuview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="sys_menu">
<table class="ewGrid"><tr><td>
<table id="tbl_sys_menuview" class="table table-bordered table-striped">
...
<%= sys_menu.menu_parent_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= sys_menu.menu_idname.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= sys_menu.menu_filename.ViewValue %>
</span>
</span>
</td>
	</tr>
...
Class csys_menu_view
	...
	Private Sub Class_Initialize()
		...
		If Request.QueryString("menu_id").Count > 0 Then
			ew_AddKey RecKey, "menu_id", Request.QueryString("menu_id")
			KeyUrl = KeyUrl & "&amp;menu_id=" & Server.URLEncode(Request.QueryString("menu_id"))
		End If
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_sys_menulist.asp" ' Return to list
			End If

			' Get action
			sys_menu.CurrentAction = "I" ' Display form
			Select Case sys_menu.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_sys_menulist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_sys_menulist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		sys_menu.RowType = EW_ROWTYPE_VIEW
