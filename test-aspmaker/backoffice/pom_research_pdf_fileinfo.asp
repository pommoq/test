...
' ASPMaker configuration for Table research_pdf_file
Dim research_pdf_file

' Define table class
Class cresearch_pdf_file
	...
	Public Property Get HighlightName()
		HighlightName = "research_pdf_file_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [research_pdf_file]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_research_pdf_filelist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_research_pdf_filelist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_research_pdf_fileview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_research_pdf_fileview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_research_pdf_fileedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_research_pdf_fileadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_research_pdf_filedelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [research_pdf_file] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get rsh_pdf_id()
		If Not IsObject(m_rsh_pdf_id) Then
			Set m_rsh_pdf_id = NewFldObj("research_pdf_file", "research_pdf_file", "x_rsh_pdf_id", "rsh_pdf_id", "[rsh_pdf_id]", "[rsh_pdf_id]", 3, 0, "[rsh_pdf_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get rsh_id()
		If Not IsObject(m_rsh_id) Then
			Set m_rsh_id = NewFldObj("research_pdf_file", "research_pdf_file", "x_rsh_id", "rsh_id", "[rsh_id]", "[rsh_id]", 3, 0, "[rsh_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get rsh_pdf_file()
		If Not IsObject(m_rsh_pdf_file) Then
			Set m_rsh_pdf_file = NewFldObj("research_pdf_file", "research_pdf_file", "x_rsh_pdf_file", "rsh_pdf_file", "[rsh_pdf_file]", "[rsh_pdf_file]", 202, 0, "[rsh_pdf_file]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_pdf_title()
		If Not IsObject(m_rsh_pdf_title) Then
			Set m_rsh_pdf_title = NewFldObj("research_pdf_file", "research_pdf_file", "x_rsh_pdf_title", "rsh_pdf_title", "[rsh_pdf_title]", "[rsh_pdf_title]", 202, 0, "[rsh_pdf_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
