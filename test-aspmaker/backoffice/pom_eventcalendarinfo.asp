...
' ASPMaker configuration for Table eventcalendar
Dim eventcalendar
...
Class ceventcalendar
	...
	Public Property Get HighlightName()
		HighlightName = "eventcalendar_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [eventcalendar]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_eventcalendarlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_eventcalendarlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_eventcalendarview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_eventcalendarview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_eventcalendaredit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_eventcalendaradd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_eventcalendardelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [eventcalendar] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get eventcalendar_id()
		If Not IsObject(m_eventcalendar_id) Then
			Set m_eventcalendar_id = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_id", "eventcalendar_id", "[eventcalendar_id]", "[eventcalendar_id]", 3, 0, "[eventcalendar_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get eventcalendar_img()
		If Not IsObject(m_eventcalendar_img) Then
			Set m_eventcalendar_img = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_img", "eventcalendar_img", "[eventcalendar_img]", "[eventcalendar_img]", 203, 0, "[eventcalendar_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_date()
		If Not IsObject(m_eventcalendar_date) Then
			Set m_eventcalendar_date = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_date", "eventcalendar_date", "[eventcalendar_date]", "FORMAT([eventcalendar_date], '')", 135, 8, "[eventcalendar_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_category()
		If Not IsObject(m_eventcalendar_category) Then
			Set m_eventcalendar_category = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_category", "eventcalendar_category", "[eventcalendar_category]", "[eventcalendar_category]", 202, 0, "[eventcalendar_category]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_category_sub()
		If Not IsObject(m_eventcalendar_category_sub) Then
			Set m_eventcalendar_category_sub = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_category_sub", "eventcalendar_category_sub", "[eventcalendar_category_sub]", "[eventcalendar_category_sub]", 202, 0, "[eventcalendar_category_sub]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get start_date()
		If Not IsObject(m_start_date) Then
			Set m_start_date = NewFldObj("eventcalendar", "eventcalendar", "x_start_date", "start_date", "[start_date]", "FORMAT([start_date], '')", 135, 8, "[start_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get end_date()
		If Not IsObject(m_end_date) Then
			Set m_end_date = NewFldObj("eventcalendar", "eventcalendar", "x_end_date", "end_date", "[end_date]", "FORMAT([end_date], '')", 135, 8, "[end_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_pdf()
		If Not IsObject(m_eventcalendar_pdf) Then
			Set m_eventcalendar_pdf = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_pdf", "eventcalendar_pdf", "[eventcalendar_pdf]", "[eventcalendar_pdf]", 202, 0, "[eventcalendar_pdf]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_subject()
		If Not IsObject(m_eventcalendar_subject) Then
			Set m_eventcalendar_subject = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_subject", "eventcalendar_subject", "[eventcalendar_subject]", "[eventcalendar_subject]", 202, 0, "[eventcalendar_subject]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_subject_th()
		If Not IsObject(m_eventcalendar_subject_th) Then
			Set m_eventcalendar_subject_th = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_subject_th", "eventcalendar_subject_th", "[eventcalendar_subject_th]", "[eventcalendar_subject_th]", 202, 0, "[eventcalendar_subject_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_intro()
		If Not IsObject(m_eventcalendar_intro) Then
			Set m_eventcalendar_intro = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_intro", "eventcalendar_intro", "[eventcalendar_intro]", "[eventcalendar_intro]", 203, 0, "[eventcalendar_intro]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_intro_th()
		If Not IsObject(m_eventcalendar_intro_th) Then
			Set m_eventcalendar_intro_th = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_intro_th", "eventcalendar_intro_th", "[eventcalendar_intro_th]", "[eventcalendar_intro_th]", 203, 0, "[eventcalendar_intro_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_content()
		If Not IsObject(m_eventcalendar_content) Then
			Set m_eventcalendar_content = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_content", "eventcalendar_content", "[eventcalendar_content]", "[eventcalendar_content]", 203, 0, "[eventcalendar_content]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_content_th()
		If Not IsObject(m_eventcalendar_content_th) Then
			Set m_eventcalendar_content_th = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_content_th", "eventcalendar_content_th", "[eventcalendar_content_th]", "[eventcalendar_content_th]", 203, 0, "[eventcalendar_content_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_show_en()
		If Not IsObject(m_eventcalendar_show_en) Then
			Set m_eventcalendar_show_en = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_show_en", "eventcalendar_show_en", "[eventcalendar_show_en]", "[eventcalendar_show_en]", 202, 0, "[eventcalendar_show_en]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_show()
		If Not IsObject(m_eventcalendar_show) Then
			Set m_eventcalendar_show = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_show", "eventcalendar_show", "[eventcalendar_show]", "[eventcalendar_show]", 202, 0, "[eventcalendar_show]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_show_home()
		If Not IsObject(m_eventcalendar_show_home) Then
			Set m_eventcalendar_show_home = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_show_home", "eventcalendar_show_home", "[eventcalendar_show_home]", "[eventcalendar_show_home]", 202, 0, "[eventcalendar_show_home]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_create()
		If Not IsObject(m_eventcalendar_create) Then
			Set m_eventcalendar_create = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_create", "eventcalendar_create", "[eventcalendar_create]", "[eventcalendar_create]", 202, 0, "[eventcalendar_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get eventcalendar_update()
		If Not IsObject(m_eventcalendar_update) Then
			Set m_eventcalendar_update = NewFldObj("eventcalendar", "eventcalendar", "x_eventcalendar_update", "eventcalendar_update", "[eventcalendar_update]", "[eventcalendar_update]", 202, 0, "[eventcalendar_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
