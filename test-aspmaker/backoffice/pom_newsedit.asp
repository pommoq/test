...
fnewsedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fnewsedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% news_edit.ShowPageHeader() %>
<% news_edit.ShowMessage %>
<form name="fnewsedit" id="fnewsedit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
...
<%= news.news_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_news_id" name="x_news_id" id="x_news_id" value="<%= Server.HTMLEncode(news.news_id.CurrentValue&"") %>">
...
<% If Request.Form("fa_x_news_img") & "" = "0" Then %>
<input type="hidden" name="fa_x_news_img" id= "fa_x_news_img" value="0">
<% Else %>
<input type="hidden" name="fa_x_news_img" id= "fa_x_news_img" value="1">
<% End If %>
...
Class cnews_edit
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			news.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
		...
		' Check if valid key
		If news.news_id.CurrentValue = "" Then Call Page_Terminate("pom_newslist.asp") ' Invalid key, return to list
	...
	Sub RenderRow()
		...
		ElseIf news.RowType = EW_ROWTYPE_EDIT Then ' Edit row
			...
			news.news_id.EditValue = news.news_id.CurrentValue
			news.news_id.ViewCustomAttributes = ""
			...
			End If
			If news.CurrentAction = "I" And Not news.EventCancelled Then Call ew_RenderUploadField(news.news_img, -1)
	...
	Function EditRow()
		...
		Else
			...
			If Not (news.news_img.ReadOnly) And Not news.news_img.Upload.KeepFile Then
				news.news_img.Upload.DbValue = Rs("news_img") ' Get original value
			...
			' Field news_date
			Call news.news_date.SetDbValue(Rs, news.news_date.CurrentValue, Null, news.news_date.ReadOnly)

			' Field news_category
			Call news.news_category.SetDbValue(Rs, news.news_category.CurrentValue, Null, news.news_category.ReadOnly)

			' Field news_category_sub
			Call news.news_category_sub.SetDbValue(Rs, news.news_category_sub.CurrentValue, Null, news.news_category_sub.ReadOnly)

			' Field start_date
			Call news.start_date.SetDbValue(Rs, news.start_date.CurrentValue, Null, news.start_date.ReadOnly)

			' Field end_date
			Call news.end_date.SetDbValue(Rs, news.end_date.CurrentValue, Null, news.end_date.ReadOnly)

			' Field news_pdf
			Call news.news_pdf.SetDbValue(Rs, news.news_pdf.CurrentValue, Null, news.news_pdf.ReadOnly)

			' Field news_subject
			Call news.news_subject.SetDbValue(Rs, news.news_subject.CurrentValue, Null, news.news_subject.ReadOnly)

			' Field news_subject_th
			Call news.news_subject_th.SetDbValue(Rs, news.news_subject_th.CurrentValue, Null, news.news_subject_th.ReadOnly)

			' Field news_intro
			Call news.news_intro.SetDbValue(Rs, news.news_intro.CurrentValue, Null, news.news_intro.ReadOnly)

			' Field news_intro_th
			Call news.news_intro_th.SetDbValue(Rs, news.news_intro_th.CurrentValue, Null, news.news_intro_th.ReadOnly)

			' Field news_content
			Call news.news_content.SetDbValue(Rs, news.news_content.CurrentValue, Null, news.news_content.ReadOnly)

			' Field news_content_th
			Call news.news_content_th.SetDbValue(Rs, news.news_content_th.CurrentValue, Null, news.news_content_th.ReadOnly)

			' Field news_show_en
			Call news.news_show_en.SetDbValue(Rs, news.news_show_en.CurrentValue, Null, news.news_show_en.ReadOnly)

			' Field news_show
			Call news.news_show.SetDbValue(Rs, news.news_show.CurrentValue, Null, news.news_show.ReadOnly)

			' Field news_show_home
			Call news.news_show_home.SetDbValue(Rs, news.news_show_home.CurrentValue, Null, news.news_show_home.ReadOnly)

			' Field news_create
			Call news.news_create.SetDbValue(Rs, news.news_create.CurrentValue, Null, news.news_create.ReadOnly)

			' Field news_update
			Call news.news_update.SetDbValue(Rs, news.news_update.CurrentValue, Null, news.news_update.ReadOnly)
			...
			bUpdateRow = news.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call news.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
