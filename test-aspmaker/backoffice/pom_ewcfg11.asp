...
' ASPMaker 11 configuration file
...
EW_SESSION_LANGUAGE_FILE_CACHE = EW_PROJECT_NAME & "_LanguageFile_ks7p2EY1QzSVov2j" ' Language File Cache
Dim EW_SESSION_LANGUAGE_CACHE
EW_SESSION_LANGUAGE_CACHE = EW_PROJECT_NAME & "_Language_ks7p2EY1QzSVov2j" ' Language Cache
...
EW_DB_CONNECTION_STRING = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & ew_ServerMapPath("./db/aspmaker.mdb") & ";"
...
' User table filters
Const EW_USER_TABLE = "[admins]"
Const EW_USER_NAME_FILTER = "([admin_username] = '%u')"
...
Const EW_DEFAULT_DATE_FORMAT = 0
...
Const EW_UPLOAD_DEST_PATH = "./Upload/" ' Upload destination path
Const EW_UPLOAD_URL = "pom_ewupload11.asp" ' Upload URL
...
' Use mobile menu
Dim EW_USE_MOBILE_MENU
EW_USE_MOBILE_MENU = True

' Reflow for mobile
Const EW_MOBILE_REFLOW = True
...
Dim EW_USE_SYSTEM_LOCALE, EW_DECIMAL_POINT, EW_THOUSANDS_SEP, EW_CURRENCY_SYMBOL
...
Dim gsExport, gsExportFile, gbSkipHeaderFooter, gbOldSkipHeaderFooter
...
Dim sFilterWrk
Dim sNewFileName
Dim TmpFile, TmpFile1, TmpFiles, TmpNewFiles, TmpNewFiles2, TmpOldFiles, TmpHrefValue, TmpFileCount, TmpFldVar
...
Const EW_MENUBAR_INNER_CLASSNAME = ""
...
Const EW_MENU_ACTIVE_ITEM_CLASS = "disabled"
Const EW_SUBMENU_ACTIVE_ITEM_CLASS = "disabled"
