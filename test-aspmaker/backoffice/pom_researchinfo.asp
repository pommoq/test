...
' ASPMaker configuration for Table research
Dim research
...
Class cresearch
	...
	Public Property Get HighlightName()
		HighlightName = "research_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [research]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_researchlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_researchlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_researchview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_researchview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_researchedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_researchadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_researchdelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [research] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get rsh_id()
		If Not IsObject(m_rsh_id) Then
			Set m_rsh_id = NewFldObj("research", "research", "x_rsh_id", "rsh_id", "[rsh_id]", "[rsh_id]", 3, 0, "[rsh_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get rsh_img()
		If Not IsObject(m_rsh_img) Then
			Set m_rsh_img = NewFldObj("research", "research", "x_rsh_img", "rsh_img", "[rsh_img]", "[rsh_img]", 202, 0, "[rsh_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_date()
		If Not IsObject(m_rsh_date) Then
			Set m_rsh_date = NewFldObj("research", "research", "x_rsh_date", "rsh_date", "[rsh_date]", "FORMAT([rsh_date], '')", 135, 8, "[rsh_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_pdf()
		If Not IsObject(m_rsh_pdf) Then
			Set m_rsh_pdf = NewFldObj("research", "research", "x_rsh_pdf", "rsh_pdf", "[rsh_pdf]", "[rsh_pdf]", 202, 0, "[rsh_pdf]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_category()
		If Not IsObject(m_rsh_category) Then
			Set m_rsh_category = NewFldObj("research", "research", "x_rsh_category", "rsh_category", "[rsh_category]", "[rsh_category]", 202, 0, "[rsh_category]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_subject()
		If Not IsObject(m_rsh_subject) Then
			Set m_rsh_subject = NewFldObj("research", "research", "x_rsh_subject", "rsh_subject", "[rsh_subject]", "[rsh_subject]", 202, 0, "[rsh_subject]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_subject_th()
		If Not IsObject(m_rsh_subject_th) Then
			Set m_rsh_subject_th = NewFldObj("research", "research", "x_rsh_subject_th", "rsh_subject_th", "[rsh_subject_th]", "[rsh_subject_th]", 202, 0, "[rsh_subject_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_intro()
		If Not IsObject(m_rsh_intro) Then
			Set m_rsh_intro = NewFldObj("research", "research", "x_rsh_intro", "rsh_intro", "[rsh_intro]", "[rsh_intro]", 203, 0, "[rsh_intro]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_intro_th()
		If Not IsObject(m_rsh_intro_th) Then
			Set m_rsh_intro_th = NewFldObj("research", "research", "x_rsh_intro_th", "rsh_intro_th", "[rsh_intro_th]", "[rsh_intro_th]", 202, 0, "[rsh_intro_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_content()
		If Not IsObject(m_rsh_content) Then
			Set m_rsh_content = NewFldObj("research", "research", "x_rsh_content", "rsh_content", "[rsh_content]", "[rsh_content]", 203, 0, "[rsh_content]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_content_th()
		If Not IsObject(m_rsh_content_th) Then
			Set m_rsh_content_th = NewFldObj("research", "research", "x_rsh_content_th", "rsh_content_th", "[rsh_content_th]", "[rsh_content_th]", 203, 0, "[rsh_content_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_show()
		If Not IsObject(m_rsh_show) Then
			Set m_rsh_show = NewFldObj("research", "research", "x_rsh_show", "rsh_show", "[rsh_show]", "[rsh_show]", 202, 0, "[rsh_show]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_show_home()
		If Not IsObject(m_rsh_show_home) Then
			Set m_rsh_show_home = NewFldObj("research", "research", "x_rsh_show_home", "rsh_show_home", "[rsh_show_home]", "[rsh_show_home]", 202, 0, "[rsh_show_home]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_create()
		If Not IsObject(m_rsh_create) Then
			Set m_rsh_create = NewFldObj("research", "research", "x_rsh_create", "rsh_create", "[rsh_create]", "[rsh_create]", 202, 0, "[rsh_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get rsh_update()
		If Not IsObject(m_rsh_update) Then
			Set m_rsh_update = NewFldObj("research", "research", "x_rsh_update", "rsh_update", "[rsh_update]", "[rsh_update]", 202, 0, "[rsh_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
