...
' ASPMaker configuration for Table office
Dim office
...
Class coffice
	...
	Public Property Get HighlightName()
		HighlightName = "office_Highlight"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_officelist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_officelist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_officeview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_officeview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_officeedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_officeadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_officedelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [office] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get office_id()
		If Not IsObject(m_office_id) Then
			Set m_office_id = NewFldObj("office", "office", "x_office_id", "office_id", "[office_id]", "[office_id]", 3, 0, "[office_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get office_name_en()
		If Not IsObject(m_office_name_en) Then
			Set m_office_name_en = NewFldObj("office", "office", "x_office_name_en", "office_name_en", "[office_name_en]", "[office_name_en]", 202, 0, "[office_name_en]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get office_name_th()
		If Not IsObject(m_office_name_th) Then
			Set m_office_name_th = NewFldObj("office", "office", "x_office_name_th", "office_name_th", "[office_name_th]", "[office_name_th]", 202, 0, "[office_name_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get office_sort()
		If Not IsObject(m_office_sort) Then
			Set m_office_sort = NewFldObj("office", "office", "x_office_sort", "office_sort", "[office_sort]", "[office_sort]", 202, 0, "[office_sort]", False, False, FALSE, "FORMATTED TEXT")
		End If
