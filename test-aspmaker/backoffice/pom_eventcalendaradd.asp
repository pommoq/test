...
' Define page object
Dim eventcalendar_add
Set eventcalendar_add = New ceventcalendar_add
Set Page = eventcalendar_add

' Page init processing
eventcalendar_add.Page_Init()

' Page main processing
eventcalendar_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
eventcalendar_add.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var eventcalendar_add = new ew_Page("eventcalendar_add");
eventcalendar_add.PageID = "add"; // Page ID
var EW_PAGE_ID = eventcalendar_add.PageID; // For backward compatibility
// Form object
var feventcalendaradd = new ew_Form("feventcalendaradd");
// Validate form
feventcalendaradd.Validate = function() {
...
feventcalendaradd.Form_CustomValidate = 
...
feventcalendaradd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
feventcalendaradd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% eventcalendar_add.ShowPageHeader() %>
<% eventcalendar_add.ShowMessage %>
<form name="feventcalendaradd" id="feventcalendaradd" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="eventcalendar">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_eventcalendaradd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_eventcalendar_id" name="x_eventcalendar_id" id="x_eventcalendar_id" size="30" placeholder="<%= eventcalendar.eventcalendar_id.PlaceHolder %>" value="<%= eventcalendar.eventcalendar_id.EditValue %>"<%= eventcalendar.eventcalendar_id.EditAttributes %>>
</span>
...
<script type="text/javascript">
feventcalendaradd.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
eventcalendar_add.ShowPageFooter()
...
Class ceventcalendar_add
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			eventcalendar.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("eventcalendar_id").Count > 0 Then
				...
				Call eventcalendar.SetKey("eventcalendar_id", eventcalendar.eventcalendar_id.CurrentValue) ' Set up key
			Else
				Call eventcalendar.SetKey("eventcalendar_id", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
				eventcalendar.CurrentAction = "C" ' Copy Record
			Else
				eventcalendar.CurrentAction = "I" ' Display Blank Record
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			If Not ValidateForm() Then
				eventcalendar.CurrentAction = "I" ' Form error, reset action
		...
		Select Case eventcalendar.CurrentAction
			...
			Case "A" ' Add new record
				eventcalendar.SendEmail = True ' Send email on add success
				If AddRow(OldRecordset) Then ' Add successful
					SuccessMessage = Language.Phrase("AddSuccess") ' Set up success message
					Dim sReturnUrl
					sReturnUrl = eventcalendar.ReturnUrl
					If ew_GetPageName(sReturnUrl) = "pom_eventcalendarview.asp" Then sReturnUrl = eventcalendar.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		eventcalendar.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Function LoadDefaultValues()
		eventcalendar.eventcalendar_id.CurrentValue = Null
		eventcalendar.eventcalendar_id.OldValue = eventcalendar.eventcalendar_id.CurrentValue
		eventcalendar.eventcalendar_img.CurrentValue = Null
		eventcalendar.eventcalendar_img.OldValue = eventcalendar.eventcalendar_img.CurrentValue
		eventcalendar.eventcalendar_date.CurrentValue = Null
		eventcalendar.eventcalendar_date.OldValue = eventcalendar.eventcalendar_date.CurrentValue
		eventcalendar.eventcalendar_category.CurrentValue = Null
		eventcalendar.eventcalendar_category.OldValue = eventcalendar.eventcalendar_category.CurrentValue
		eventcalendar.eventcalendar_category_sub.CurrentValue = Null
		eventcalendar.eventcalendar_category_sub.OldValue = eventcalendar.eventcalendar_category_sub.CurrentValue
		eventcalendar.start_date.CurrentValue = Null
		eventcalendar.start_date.OldValue = eventcalendar.start_date.CurrentValue
		eventcalendar.end_date.CurrentValue = Null
		eventcalendar.end_date.OldValue = eventcalendar.end_date.CurrentValue
		eventcalendar.eventcalendar_pdf.CurrentValue = Null
		eventcalendar.eventcalendar_pdf.OldValue = eventcalendar.eventcalendar_pdf.CurrentValue
		eventcalendar.eventcalendar_subject.CurrentValue = Null
		eventcalendar.eventcalendar_subject.OldValue = eventcalendar.eventcalendar_subject.CurrentValue
		eventcalendar.eventcalendar_subject_th.CurrentValue = Null
		eventcalendar.eventcalendar_subject_th.OldValue = eventcalendar.eventcalendar_subject_th.CurrentValue
		eventcalendar.eventcalendar_intro.CurrentValue = Null
		eventcalendar.eventcalendar_intro.OldValue = eventcalendar.eventcalendar_intro.CurrentValue
		eventcalendar.eventcalendar_intro_th.CurrentValue = Null
		eventcalendar.eventcalendar_intro_th.OldValue = eventcalendar.eventcalendar_intro_th.CurrentValue
		eventcalendar.eventcalendar_content.CurrentValue = Null
		eventcalendar.eventcalendar_content.OldValue = eventcalendar.eventcalendar_content.CurrentValue
		eventcalendar.eventcalendar_content_th.CurrentValue = Null
		eventcalendar.eventcalendar_content_th.OldValue = eventcalendar.eventcalendar_content_th.CurrentValue
		eventcalendar.eventcalendar_show_en.CurrentValue = Null
		eventcalendar.eventcalendar_show_en.OldValue = eventcalendar.eventcalendar_show_en.CurrentValue
		eventcalendar.eventcalendar_show.CurrentValue = Null
		eventcalendar.eventcalendar_show.OldValue = eventcalendar.eventcalendar_show.CurrentValue
		eventcalendar.eventcalendar_show_home.CurrentValue = Null
		eventcalendar.eventcalendar_show_home.OldValue = eventcalendar.eventcalendar_show_home.CurrentValue
		eventcalendar.eventcalendar_create.CurrentValue = Null
		eventcalendar.eventcalendar_create.OldValue = eventcalendar.eventcalendar_create.CurrentValue
		eventcalendar.eventcalendar_update.CurrentValue = Null
		eventcalendar.eventcalendar_update.OldValue = eventcalendar.eventcalendar_update.CurrentValue
	End Function
	...
	Sub RenderRow()
		...
		ElseIf eventcalendar.RowType = EW_ROWTYPE_ADD Then ' Add row

			' eventcalendar_id
			eventcalendar.eventcalendar_id.EditCustomAttributes = ""
			eventcalendar.eventcalendar_id.EditValue = ew_HtmlEncode(eventcalendar.eventcalendar_id.CurrentValue)
			eventcalendar.eventcalendar_id.PlaceHolder = ew_HtmlEncode(ew_RemoveHtml(eventcalendar.eventcalendar_id.FldCaption))
	...
	Function AddRow(RsOld)
		...
		If eventcalendar.eventcalendar_id.CurrentValue <> "" Then ' Check field with unique index
			sFilter = "([eventcalendar_id] = " & ew_AdjustSql(eventcalendar.eventcalendar_id.CurrentValue) & ")"
			Set RsChk = eventcalendar.LoadRs(sFilter)
			If Not (RsChk Is Nothing) Then
				sIdxErrMsg = Replace(Language.Phrase("DupIndex"), "%f", eventcalendar.eventcalendar_id.FldCaption)
				sIdxErrMsg = Replace(sIdxErrMsg, "%v", eventcalendar.eventcalendar_id.CurrentValue)
		...
		Call eventcalendar.eventcalendar_id.SetDbValue(Rs, eventcalendar.eventcalendar_id.CurrentValue, Null, False)

		' Field eventcalendar_img
		Call eventcalendar.eventcalendar_img.SetDbValue(Rs, eventcalendar.eventcalendar_img.CurrentValue, Null, False)

		' Field eventcalendar_date
		Call eventcalendar.eventcalendar_date.SetDbValue(Rs, eventcalendar.eventcalendar_date.CurrentValue, Null, False)

		' Field eventcalendar_category
		Call eventcalendar.eventcalendar_category.SetDbValue(Rs, eventcalendar.eventcalendar_category.CurrentValue, Null, False)

		' Field eventcalendar_category_sub
		Call eventcalendar.eventcalendar_category_sub.SetDbValue(Rs, eventcalendar.eventcalendar_category_sub.CurrentValue, Null, False)

		' Field start_date
		Call eventcalendar.start_date.SetDbValue(Rs, eventcalendar.start_date.CurrentValue, Null, False)

		' Field end_date
		Call eventcalendar.end_date.SetDbValue(Rs, eventcalendar.end_date.CurrentValue, Null, False)

		' Field eventcalendar_pdf
		Call eventcalendar.eventcalendar_pdf.SetDbValue(Rs, eventcalendar.eventcalendar_pdf.CurrentValue, Null, False)

		' Field eventcalendar_subject
		Call eventcalendar.eventcalendar_subject.SetDbValue(Rs, eventcalendar.eventcalendar_subject.CurrentValue, Null, False)

		' Field eventcalendar_subject_th
		Call eventcalendar.eventcalendar_subject_th.SetDbValue(Rs, eventcalendar.eventcalendar_subject_th.CurrentValue, Null, False)

		' Field eventcalendar_intro
		Call eventcalendar.eventcalendar_intro.SetDbValue(Rs, eventcalendar.eventcalendar_intro.CurrentValue, Null, False)

		' Field eventcalendar_intro_th
		Call eventcalendar.eventcalendar_intro_th.SetDbValue(Rs, eventcalendar.eventcalendar_intro_th.CurrentValue, Null, False)

		' Field eventcalendar_content
		Call eventcalendar.eventcalendar_content.SetDbValue(Rs, eventcalendar.eventcalendar_content.CurrentValue, Null, False)

		' Field eventcalendar_content_th
		Call eventcalendar.eventcalendar_content_th.SetDbValue(Rs, eventcalendar.eventcalendar_content_th.CurrentValue, Null, False)

		' Field eventcalendar_show_en
		Call eventcalendar.eventcalendar_show_en.SetDbValue(Rs, eventcalendar.eventcalendar_show_en.CurrentValue, Null, False)

		' Field eventcalendar_show
		Call eventcalendar.eventcalendar_show.SetDbValue(Rs, eventcalendar.eventcalendar_show.CurrentValue, Null, False)

		' Field eventcalendar_show_home
		Call eventcalendar.eventcalendar_show_home.SetDbValue(Rs, eventcalendar.eventcalendar_show_home.CurrentValue, Null, False)

		' Field eventcalendar_create
		Call eventcalendar.eventcalendar_create.SetDbValue(Rs, eventcalendar.eventcalendar_create.CurrentValue, Null, False)

		' Field eventcalendar_update
		Call eventcalendar.eventcalendar_update.SetDbValue(Rs, eventcalendar.eventcalendar_update.CurrentValue, Null, False)
		...
		bInsertRow = eventcalendar.Row_Inserting(RsOld, Rs)

		' Check if key value entered
		If bInsertRow And eventcalendar.ValidateKey And eventcalendar.eventcalendar_id.CurrentValue = "" And eventcalendar.eventcalendar_id.SessionValue = "" Then
		...
		Dim sKeyErrMsg
		If bInsertRow And eventcalendar.ValidateKey Then
			sFilter = eventcalendar.KeyFilter
			Set RsChk = eventcalendar.LoadRs(sFilter)
			If Not (RsChk Is Nothing) Then
		...
		If AddRow Then
			...
			Call eventcalendar.Row_Inserted(RsOld, RsNew)
		End If
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(eventcalendar.CurrentAction = "C", "Copy", "Add")
