...
' ASPMaker configuration for Table person
Dim person
...
Class cperson
	...
	Public Property Get HighlightName()
		HighlightName = "person_Highlight"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_personlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_personlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_personview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_personview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_personedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_personadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_persondelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [person] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get per_id()
		If Not IsObject(m_per_id) Then
			Set m_per_id = NewFldObj("person", "person", "x_per_id", "per_id", "[per_id]", "[per_id]", 3, 0, "[per_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get dept_id()
		If Not IsObject(m_dept_id) Then
			Set m_dept_id = NewFldObj("person", "person", "x_dept_id", "dept_id", "[dept_id]", "[dept_id]", 3, 0, "[dept_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get office_id()
		If Not IsObject(m_office_id) Then
			Set m_office_id = NewFldObj("person", "person", "x_office_id", "office_id", "[office_id]", "[office_id]", 3, 0, "[office_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get per_img()
		If Not IsObject(m_per_img) Then
			Set m_per_img = NewFldObj("person", "person", "x_per_img", "per_img", "[per_img]", "[per_img]", 202, 0, "[per_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_en_name()
		If Not IsObject(m_per_en_name) Then
			Set m_per_en_name = NewFldObj("person", "person", "x_per_en_name", "per_en_name", "[per_en_name]", "[per_en_name]", 202, 0, "[per_en_name]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_th_name()
		If Not IsObject(m_per_th_name) Then
			Set m_per_th_name = NewFldObj("person", "person", "x_per_th_name", "per_th_name", "[per_th_name]", "[per_th_name]", 202, 0, "[per_th_name]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_position()
		If Not IsObject(m_per_position) Then
			Set m_per_position = NewFldObj("person", "person", "x_per_position", "per_position", "[per_position]", "[per_position]", 202, 0, "[per_position]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_mobile()
		If Not IsObject(m_per_mobile) Then
			Set m_per_mobile = NewFldObj("person", "person", "x_per_mobile", "per_mobile", "[per_mobile]", "[per_mobile]", 202, 0, "[per_mobile]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_tel()
		If Not IsObject(m_per_tel) Then
			Set m_per_tel = NewFldObj("person", "person", "x_per_tel", "per_tel", "[per_tel]", "[per_tel]", 202, 0, "[per_tel]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_fax()
		If Not IsObject(m_per_fax) Then
			Set m_per_fax = NewFldObj("person", "person", "x_per_fax", "per_fax", "[per_fax]", "[per_fax]", 202, 0, "[per_fax]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_email()
		If Not IsObject(m_per_email) Then
			Set m_per_email = NewFldObj("person", "person", "x_per_email", "per_email", "[per_email]", "[per_email]", 202, 0, "[per_email]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_address()
		If Not IsObject(m_per_address) Then
			Set m_per_address = NewFldObj("person", "person", "x_per_address", "per_address", "[per_address]", "[per_address]", 202, 0, "[per_address]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_show()
		If Not IsObject(m_per_show) Then
			Set m_per_show = NewFldObj("person", "person", "x_per_show", "per_show", "[per_show]", "[per_show]", 202, 0, "[per_show]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_create()
		If Not IsObject(m_per_create) Then
			Set m_per_create = NewFldObj("person", "person", "x_per_create", "per_create", "[per_create]", "[per_create]", 202, 0, "[per_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_update()
		If Not IsObject(m_per_update) Then
			Set m_per_update = NewFldObj("person", "person", "x_per_update", "per_update", "[per_update]", "[per_update]", 202, 0, "[per_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get per_sort()
		If Not IsObject(m_per_sort) Then
			Set m_per_sort = NewFldObj("person", "person", "x_per_sort", "per_sort", "[per_sort]", "[per_sort]", 3, 0, "[per_sort]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get per_department()
		If Not IsObject(m_per_department) Then
			Set m_per_department = NewFldObj("person", "person", "x_per_department", "per_department", "[per_department]", "[per_department]", 202, 0, "[per_department]", False, False, FALSE, "FORMATTED TEXT")
		End If
