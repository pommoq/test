...
' Define page object
Dim job_file_th_edit
Set job_file_th_edit = New cjob_file_th_edit
Set Page = job_file_th_edit

' Page init processing
job_file_th_edit.Page_Init()

' Page main processing
job_file_th_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
job_file_th_edit.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var job_file_th_edit = new ew_Page("job_file_th_edit");
job_file_th_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = job_file_th_edit.PageID; // For backward compatibility
// Form object
var fjob_file_thedit = new ew_Form("fjob_file_thedit");
// Validate form
fjob_file_thedit.Validate = function() {
...
fjob_file_thedit.Form_CustomValidate = 
...
fjob_file_thedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fjob_file_thedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% job_file_th_edit.ShowPageHeader() %>
<% job_file_th_edit.ShowMessage %>
<form name="fjob_file_thedit" id="fjob_file_thedit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="a_table" id="a_table" value="job_file_th">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_job_file_thedit" class="table table-bordered table-striped">
<% If job_file_th.job_file_id.Visible Then ' job_file_id %>
	<tr id="r_job_file_id">
		<td><span id="elh_job_file_th_job_file_id"><%= job_file_th.job_file_id.FldCaption %></span></td>
		<td<%= job_file_th.job_file_id.CellAttributes %>>
<span id="el_job_file_th_job_file_id" class="control-group">
<span<%= job_file_th.job_file_id.ViewAttributes %>>
<%= job_file_th.job_file_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_job_file_id" name="x_job_file_id" id="x_job_file_id" value="<%= Server.HTMLEncode(job_file_th.job_file_id.CurrentValue&"") %>">
<%= job_file_th.job_file_id.CustomMsg %></td>
	</tr>
<% End If %>
...
<script type="text/javascript">
fjob_file_thedit.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
job_file_th_edit.ShowPageFooter()
...
Class cjob_file_th_edit
	...
	Sub Page_Init()
		...
		job_file_th.job_file_id.Visible = Not job_file_th.IsAdd() And Not job_file_th.IsCopy() And Not job_file_th.IsGridAdd()
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			job_file_th.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			job_file_th.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If job_file_th.job_file_id.CurrentValue = "" Then Call Page_Terminate("pom_job_file_thlist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				job_file_th.CurrentAction = "" ' Form error, reset action
		...
		Select Case job_file_th.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				job_file_th.SendEmail = True ' Send email on update success
		...
		' Render the record
		job_file_th.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Function LoadFormValues()
		...
		If Not job_file_th.job_file_id.FldIsDetailKey Then job_file_th.job_file_id.FormValue = ObjForm.GetValue("x_job_file_id")
	...
	Function RestoreFormValues()
		Call LoadRow()
		job_file_th.job_file_id.CurrentValue = job_file_th.job_file_id.FormValue
	...
	Sub RenderRow()
		...
		ElseIf job_file_th.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' job_file_id
			job_file_th.job_file_id.EditCustomAttributes = ""
			job_file_th.job_file_id.EditValue = job_file_th.job_file_id.CurrentValue
			job_file_th.job_file_id.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			' Field job_id
			Call job_file_th.job_id.SetDbValue(Rs, job_file_th.job_id.CurrentValue, Null, job_file_th.job_id.ReadOnly)

			' Field job_file_name
			Call job_file_th.job_file_name.SetDbValue(Rs, job_file_th.job_file_name.CurrentValue, Null, job_file_th.job_file_name.ReadOnly)

			' Field job_file_title
			Call job_file_th.job_file_title.SetDbValue(Rs, job_file_th.job_file_title.CurrentValue, Null, job_file_th.job_file_title.ReadOnly)
			...
			bUpdateRow = job_file_th.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call job_file_th.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
