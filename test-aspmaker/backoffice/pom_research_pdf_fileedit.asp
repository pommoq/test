...
' Define page object
Dim research_pdf_file_edit
Set research_pdf_file_edit = New cresearch_pdf_file_edit
Set Page = research_pdf_file_edit

' Page init processing
research_pdf_file_edit.Page_Init()

' Page main processing
research_pdf_file_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
research_pdf_file_edit.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var research_pdf_file_edit = new ew_Page("research_pdf_file_edit");
research_pdf_file_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = research_pdf_file_edit.PageID; // For backward compatibility
// Form object
var fresearch_pdf_fileedit = new ew_Form("fresearch_pdf_fileedit");
// Validate form
fresearch_pdf_fileedit.Validate = function() {
...
fresearch_pdf_fileedit.Form_CustomValidate = 
...
fresearch_pdf_fileedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fresearch_pdf_fileedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% research_pdf_file_edit.ShowPageHeader() %>
<% research_pdf_file_edit.ShowMessage %>
<form name="fresearch_pdf_fileedit" id="fresearch_pdf_fileedit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="a_table" id="a_table" value="research_pdf_file">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_research_pdf_fileedit" class="table table-bordered table-striped">
<% If research_pdf_file.rsh_pdf_id.Visible Then ' rsh_pdf_id %>
	<tr id="r_rsh_pdf_id">
		<td><span id="elh_research_pdf_file_rsh_pdf_id"><%= research_pdf_file.rsh_pdf_id.FldCaption %></span></td>
		<td<%= research_pdf_file.rsh_pdf_id.CellAttributes %>>
<span id="el_research_pdf_file_rsh_pdf_id" class="control-group">
<span<%= research_pdf_file.rsh_pdf_id.ViewAttributes %>>
<%= research_pdf_file.rsh_pdf_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_rsh_pdf_id" name="x_rsh_pdf_id" id="x_rsh_pdf_id" value="<%= Server.HTMLEncode(research_pdf_file.rsh_pdf_id.CurrentValue&"") %>">
<%= research_pdf_file.rsh_pdf_id.CustomMsg %></td>
	</tr>
<% End If %>
...
<script type="text/javascript">
fresearch_pdf_fileedit.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
research_pdf_file_edit.ShowPageFooter()
...
' Drop page object
Set research_pdf_file_edit = Nothing
%>
<%
...
Class cresearch_pdf_file_edit
	...
	Public Property Get PageObjName()
		PageObjName = "research_pdf_file_edit"
	End Property
	...
	Sub Page_Init()
		...
		research_pdf_file.rsh_pdf_id.Visible = Not research_pdf_file.IsAdd() And Not research_pdf_file.IsCopy() And Not research_pdf_file.IsGridAdd()
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			research_pdf_file.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			research_pdf_file.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If research_pdf_file.rsh_pdf_id.CurrentValue = "" Then Call Page_Terminate("pom_research_pdf_filelist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				research_pdf_file.CurrentAction = "" ' Form error, reset action
		...
		Select Case research_pdf_file.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				research_pdf_file.SendEmail = True ' Send email on update success
		...
		' Render the record
		research_pdf_file.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Function LoadFormValues()
		...
		If Not research_pdf_file.rsh_pdf_id.FldIsDetailKey Then research_pdf_file.rsh_pdf_id.FormValue = ObjForm.GetValue("x_rsh_pdf_id")
	...
	Function RestoreFormValues()
		Call LoadRow()
		research_pdf_file.rsh_pdf_id.CurrentValue = research_pdf_file.rsh_pdf_id.FormValue
	...
	Sub RenderRow()
		...
		ElseIf research_pdf_file.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' rsh_pdf_id
			research_pdf_file.rsh_pdf_id.EditCustomAttributes = ""
			research_pdf_file.rsh_pdf_id.EditValue = research_pdf_file.rsh_pdf_id.CurrentValue
			research_pdf_file.rsh_pdf_id.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			' Field rsh_id
			Call research_pdf_file.rsh_id.SetDbValue(Rs, research_pdf_file.rsh_id.CurrentValue, Null, research_pdf_file.rsh_id.ReadOnly)

			' Field rsh_pdf_file
			Call research_pdf_file.rsh_pdf_file.SetDbValue(Rs, research_pdf_file.rsh_pdf_file.CurrentValue, Null, research_pdf_file.rsh_pdf_file.ReadOnly)

			' Field rsh_pdf_title
			Call research_pdf_file.rsh_pdf_title.SetDbValue(Rs, research_pdf_file.rsh_pdf_title.CurrentValue, Null, research_pdf_file.rsh_pdf_title.ReadOnly)
			...
			bUpdateRow = research_pdf_file.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call research_pdf_file.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
