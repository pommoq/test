...
' ASPMaker configuration for Table vehicle_record
Dim vehicle_record

' Define table class
Class cvehicle_record
	...
	Public Property Get HighlightName()
		HighlightName = "vehicle_record_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [vehicle_record]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_vehicle_recordlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_vehicle_recordlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_vehicle_recordview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_vehicle_recordview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_vehicle_recordedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_vehicle_recordadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_vehicle_recorddelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [vehicle_record] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get veh_id()
		If Not IsObject(m_veh_id) Then
			Set m_veh_id = NewFldObj("vehicle_record", "vehicle_record", "x_veh_id", "veh_id", "[veh_id]", "[veh_id]", 3, 0, "[veh_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get vch_month()
		If Not IsObject(m_vch_month) Then
			Set m_vch_month = NewFldObj("vehicle_record", "vehicle_record", "x_vch_month", "vch_month", "[vch_month]", "[vch_month]", 202, 0, "[vch_month]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get vch_year()
		If Not IsObject(m_vch_year) Then
			Set m_vch_year = NewFldObj("vehicle_record", "vehicle_record", "x_vch_year", "vch_year", "[vch_year]", "[vch_year]", 202, 0, "[vch_year]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_1()
		If Not IsObject(m_veh_product_1) Then
			Set m_veh_product_1 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_1", "veh_product_1", "[veh_product_1]", "[veh_product_1]", 202, 0, "[veh_product_1]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_2()
		If Not IsObject(m_veh_product_2) Then
			Set m_veh_product_2 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_2", "veh_product_2", "[veh_product_2]", "[veh_product_2]", 202, 0, "[veh_product_2]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_3()
		If Not IsObject(m_veh_product_3) Then
			Set m_veh_product_3 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_3", "veh_product_3", "[veh_product_3]", "[veh_product_3]", 202, 0, "[veh_product_3]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_4()
		If Not IsObject(m_veh_product_4) Then
			Set m_veh_product_4 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_4", "veh_product_4", "[veh_product_4]", "[veh_product_4]", 202, 0, "[veh_product_4]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_5()
		If Not IsObject(m_veh_product_5) Then
			Set m_veh_product_5 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_5", "veh_product_5", "[veh_product_5]", "[veh_product_5]", 202, 0, "[veh_product_5]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_6()
		If Not IsObject(m_veh_product_6) Then
			Set m_veh_product_6 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_6", "veh_product_6", "[veh_product_6]", "[veh_product_6]", 202, 0, "[veh_product_6]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_7()
		If Not IsObject(m_veh_product_7) Then
			Set m_veh_product_7 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_7", "veh_product_7", "[veh_product_7]", "[veh_product_7]", 202, 0, "[veh_product_7]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_product_8()
		If Not IsObject(m_veh_product_8) Then
			Set m_veh_product_8 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_product_8", "veh_product_8", "[veh_product_8]", "[veh_product_8]", 202, 0, "[veh_product_8]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_1()
		If Not IsObject(m_veh_domes_1) Then
			Set m_veh_domes_1 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_1", "veh_domes_1", "[veh_domes_1]", "[veh_domes_1]", 202, 0, "[veh_domes_1]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_2()
		If Not IsObject(m_veh_domes_2) Then
			Set m_veh_domes_2 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_2", "veh_domes_2", "[veh_domes_2]", "[veh_domes_2]", 202, 0, "[veh_domes_2]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_3()
		If Not IsObject(m_veh_domes_3) Then
			Set m_veh_domes_3 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_3", "veh_domes_3", "[veh_domes_3]", "[veh_domes_3]", 202, 0, "[veh_domes_3]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_4()
		If Not IsObject(m_veh_domes_4) Then
			Set m_veh_domes_4 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_4", "veh_domes_4", "[veh_domes_4]", "[veh_domes_4]", 202, 0, "[veh_domes_4]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_5()
		If Not IsObject(m_veh_domes_5) Then
			Set m_veh_domes_5 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_5", "veh_domes_5", "[veh_domes_5]", "[veh_domes_5]", 202, 0, "[veh_domes_5]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_6()
		If Not IsObject(m_veh_domes_6) Then
			Set m_veh_domes_6 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_6", "veh_domes_6", "[veh_domes_6]", "[veh_domes_6]", 202, 0, "[veh_domes_6]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_7()
		If Not IsObject(m_veh_domes_7) Then
			Set m_veh_domes_7 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_7", "veh_domes_7", "[veh_domes_7]", "[veh_domes_7]", 202, 0, "[veh_domes_7]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_domes_8()
		If Not IsObject(m_veh_domes_8) Then
			Set m_veh_domes_8 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_domes_8", "veh_domes_8", "[veh_domes_8]", "[veh_domes_8]", 202, 0, "[veh_domes_8]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_1()
		If Not IsObject(m_veh_export_1) Then
			Set m_veh_export_1 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_1", "veh_export_1", "[veh_export_1]", "[veh_export_1]", 202, 0, "[veh_export_1]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_2()
		If Not IsObject(m_veh_export_2) Then
			Set m_veh_export_2 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_2", "veh_export_2", "[veh_export_2]", "[veh_export_2]", 202, 0, "[veh_export_2]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_3()
		If Not IsObject(m_veh_export_3) Then
			Set m_veh_export_3 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_3", "veh_export_3", "[veh_export_3]", "[veh_export_3]", 202, 0, "[veh_export_3]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_4()
		If Not IsObject(m_veh_export_4) Then
			Set m_veh_export_4 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_4", "veh_export_4", "[veh_export_4]", "[veh_export_4]", 202, 0, "[veh_export_4]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_5()
		If Not IsObject(m_veh_export_5) Then
			Set m_veh_export_5 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_5", "veh_export_5", "[veh_export_5]", "[veh_export_5]", 202, 0, "[veh_export_5]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_6()
		If Not IsObject(m_veh_export_6) Then
			Set m_veh_export_6 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_6", "veh_export_6", "[veh_export_6]", "[veh_export_6]", 202, 0, "[veh_export_6]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_7()
		If Not IsObject(m_veh_export_7) Then
			Set m_veh_export_7 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_7", "veh_export_7", "[veh_export_7]", "[veh_export_7]", 202, 0, "[veh_export_7]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_export_8()
		If Not IsObject(m_veh_export_8) Then
			Set m_veh_export_8 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_export_8", "veh_export_8", "[veh_export_8]", "[veh_export_8]", 202, 0, "[veh_export_8]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_remark()
		If Not IsObject(m_veh_remark) Then
			Set m_veh_remark = NewFldObj("vehicle_record", "vehicle_record", "x_veh_remark", "veh_remark", "[veh_remark]", "[veh_remark]", 203, 0, "[veh_remark]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_month_title()
		If Not IsObject(m_veh_month_title) Then
			Set m_veh_month_title = NewFldObj("vehicle_record", "vehicle_record", "x_veh_month_title", "veh_month_title", "[veh_month_title]", "[veh_month_title]", 202, 0, "[veh_month_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_range()
		If Not IsObject(m_veh_range) Then
			Set m_veh_range = NewFldObj("vehicle_record", "vehicle_record", "x_veh_range", "veh_range", "[veh_range]", "[veh_range]", 202, 0, "[veh_range]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_month_title2()
		If Not IsObject(m_veh_month_title2) Then
			Set m_veh_month_title2 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_month_title2", "veh_month_title2", "[veh_month_title2]", "[veh_month_title2]", 202, 0, "[veh_month_title2]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get veh_range2()
		If Not IsObject(m_veh_range2) Then
			Set m_veh_range2 = NewFldObj("vehicle_record", "vehicle_record", "x_veh_range2", "veh_range2", "[veh_range2]", "[veh_range2]", 202, 0, "[veh_range2]", False, False, FALSE, "FORMATTED TEXT")
		End If
