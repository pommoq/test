...
' Define page object
Dim news_pdf_file_th_delete
Set news_pdf_file_th_delete = New cnews_pdf_file_th_delete
Set Page = news_pdf_file_th_delete

' Page init processing
news_pdf_file_th_delete.Page_Init()

' Page main processing
news_pdf_file_th_delete.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
news_pdf_file_th_delete.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var news_pdf_file_th_delete = new ew_Page("news_pdf_file_th_delete");
news_pdf_file_th_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = news_pdf_file_th_delete.PageID; // For backward compatibility
// Form object
var fnews_pdf_file_thdelete = new ew_Form("fnews_pdf_file_thdelete");
// Form_CustomValidate event
fnews_pdf_file_thdelete.Form_CustomValidate = 
...
fnews_pdf_file_thdelete.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fnews_pdf_file_thdelete.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
Set news_pdf_file_th_delete.Recordset = news_pdf_file_th_delete.LoadRecordset()
news_pdf_file_th_delete.TotalRecs = news_pdf_file_th_delete.Recordset.RecordCount ' Get record count
If news_pdf_file_th_delete.TotalRecs <= 0 Then ' No record found, exit
	news_pdf_file_th_delete.Recordset.Close
	Set news_pdf_file_th_delete.Recordset = Nothing
	Call news_pdf_file_th_delete.Page_Terminate("pom_news_pdf_file_thlist.asp") ' Return to list
End If
%>
<% If news_pdf_file_th.Export = "" Then %>
<% Breadcrumb.Render() %>
<% End If %>
<% news_pdf_file_th_delete.ShowPageHeader() %>
<% news_pdf_file_th_delete.ShowMessage %>
<form name="fnews_pdf_file_thdelete" id="fnews_pdf_file_thdelete" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="news_pdf_file_th">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<% For i = 0 to UBound(news_pdf_file_th_delete.RecKeys) %>
<input type="hidden" name="key_m" id="key_m" value="<%= ew_HtmlEncode(ew_GetKeyValue(news_pdf_file_th_delete.RecKeys(i))) %>">
<% Next %>
<table class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_news_pdf_file_thdelete" class="ewTable ewTableSeparate">
<%= news_pdf_file_th.TableCustomInnerHtml %>
	<thead>
	<tr class="ewTableHeader">
<% If news_pdf_file_th.news_pdf_id.Visible Then ' news_pdf_id %>
		<td><span id="elh_news_pdf_file_th_news_pdf_id" class="news_pdf_file_th_news_pdf_id"><%= news_pdf_file_th.news_pdf_id.FldCaption %></span></td>
<% End If %>
<% If news_pdf_file_th.news_id.Visible Then ' news_id %>
		<td><span id="elh_news_pdf_file_th_news_id" class="news_pdf_file_th_news_id"><%= news_pdf_file_th.news_id.FldCaption %></span></td>
<% End If %>
<% If news_pdf_file_th.news_pdf_file.Visible Then ' news_pdf_file %>
		<td><span id="elh_news_pdf_file_th_news_pdf_file" class="news_pdf_file_th_news_pdf_file"><%= news_pdf_file_th.news_pdf_file.FldCaption %></span></td>
<% End If %>
<% If news_pdf_file_th.news_pdf_title.Visible Then ' news_pdf_title %>
		<td><span id="elh_news_pdf_file_th_news_pdf_title" class="news_pdf_file_th_news_pdf_title"><%= news_pdf_file_th.news_pdf_title.FldCaption %></span></td>
<% End If %>
	</tr>
	</thead>
	<tbody>
<%
news_pdf_file_th_delete.RecCnt = 0
news_pdf_file_th_delete.RowCnt = 0
Do While (Not news_pdf_file_th_delete.Recordset.Eof)
	news_pdf_file_th_delete.RecCnt = news_pdf_file_th_delete.RecCnt + 1
	news_pdf_file_th_delete.RowCnt = news_pdf_file_th_delete.RowCnt + 1

	' Set row properties
	Call news_pdf_file_th.ResetAttrs()
	news_pdf_file_th.RowType = EW_ROWTYPE_VIEW ' view

	' Get the field contents
	Call news_pdf_file_th_delete.LoadRowValues(news_pdf_file_th_delete.Recordset)

	' Render row
	Call news_pdf_file_th_delete.RenderRow()
%>
	<tr<%= news_pdf_file_th.RowAttributes %>>
<% If news_pdf_file_th.news_pdf_id.Visible Then ' news_pdf_id %>
		<td<%= news_pdf_file_th.news_pdf_id.CellAttributes %>>
<span id="el<%= news_pdf_file_th_delete.RowCnt %>_news_pdf_file_th_news_pdf_id" class="control-group news_pdf_file_th_news_pdf_id">
...
<span id="el<%= news_pdf_file_th_delete.RowCnt %>_news_pdf_file_th_news_id" class="control-group news_pdf_file_th_news_id">
...
<span id="el<%= news_pdf_file_th_delete.RowCnt %>_news_pdf_file_th_news_pdf_file" class="control-group news_pdf_file_th_news_pdf_file">
...
<span id="el<%= news_pdf_file_th_delete.RowCnt %>_news_pdf_file_th_news_pdf_title" class="control-group news_pdf_file_th_news_pdf_title">
...
<%
	news_pdf_file_th_delete.Recordset.MoveNext
Loop
news_pdf_file_th_delete.Recordset.Close
Set news_pdf_file_th_delete.Recordset = Nothing
%>
...
<script type="text/javascript">
fnews_pdf_file_thdelete.Init();
</script>
<%
news_pdf_file_th_delete.ShowPageFooter()
...
' Drop page object
Set news_pdf_file_th_delete = Nothing
%>
<%
...
' Page Class
'
Class cnews_pdf_file_th_delete
	...
	Public Property Get PageObjName()
		PageObjName = "news_pdf_file_th_delete"
	End Property
	...
	Sub Page_Main()
		...
		' Load Key Parameters
		RecKeys = news_pdf_file_th.GetRecordKeys() ' Load record keys
		sFilter = news_pdf_file_th.GetKeyFilter()
		If sFilter = "" Then
			Call Page_Terminate("pom_news_pdf_file_thlist.asp") ' Prevent SQL injection, return to list
		End If

		' Set up filter (Sql Where Clause) and get Return Sql
		' Sql constructor in news_pdf_file_th class, news_pdf_file_thinfo.asp

		news_pdf_file_th.CurrentFilter = sFilter

		' Get action
		If Request.Form("a_delete").Count > 0 Then
			news_pdf_file_th.CurrentAction = Request.Form("a_delete")
		Else
			news_pdf_file_th.CurrentAction = "I"	' Display record
		End If
		Select Case news_pdf_file_th.CurrentAction
			Case "D" ' Delete
				news_pdf_file_th.SendEmail = True ' Send email on delete success
				If DeleteRows() Then ' Delete rows
					SuccessMessage = Language.Phrase("DeleteSuccess") ' Set up success message
					Call Page_Terminate(news_pdf_file_th.ReturnUrl) ' Return to caller
				End If
		End Select
	End Sub
	...
	Function DeleteRows()
		...
		If DeleteRows Then
			...
			Do While Not RsDelete.Eof
				DeleteRows = news_pdf_file_th.Row_Deleting(RsDelete)
		...
		If DeleteRows Then
			...
			Do While Not RsOld.Eof
				Call news_pdf_file_th.Row_Deleted(RsOld)
				RsOld.MoveNext
			Loop
		End If
		RsOld.Close
