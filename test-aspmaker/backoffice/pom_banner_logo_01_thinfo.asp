...
' ASPMaker configuration for Table banner_logo_01_th
Dim banner_logo_01_th

' Define table class
Class cbanner_logo_01_th
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "banner_id", banner_id)
		Call ew_SetArObj(Fields, "banner_img", banner_img)
		Call ew_SetArObj(Fields, "banner_link", banner_link)
		Call ew_SetArObj(Fields, "banner_sort", banner_sort)
	...
	Public Property Get HighlightName()
		HighlightName = "banner_logo_01_th_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [banner_logo_01_th]"
	End Property
	...
	Private Property Get SqlKeyFilter()
		SqlKeyFilter = "[banner_id] = @banner_id@"
	End Property
	...
	Public Property Get KeyFilter()
		...
		If Not IsNumeric(banner_id.CurrentValue) Then
			sKeyFilter = "0=1" ' Invalid key
		End If
		sKeyFilter = Replace(sKeyFilter, "@banner_id@", ew_AdjustSql(banner_id.CurrentValue)) ' Replace key value
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_banner_logo_01_thlist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_banner_logo_01_thlist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_banner_logo_01_thview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_banner_logo_01_thview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_banner_logo_01_thedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_banner_logo_01_thadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_banner_logo_01_thdelete.asp", UrlParm(""))
	End Function
	...
	Public Function KeyUrl(url, parm)
		...
		If Not IsNull(banner_id.CurrentValue) Then
			sUrl = sUrl & "banner_id=" & banner_id.CurrentValue
		Else
	...
	Public Function GetRecordKeys()
		...
		If Not bHasKey Then
			...
			ElseIf Request.QueryString <> "" Then
				ReDim arKeys(0)
				arKeys(0) = Request.QueryString("banner_id") ' banner_id
	...
	Public Sub LoadListRowValues(RsRow)
		banner_id.DbValue = RsRow("banner_id")
		banner_img.DbValue = RsRow("banner_img")
		banner_link.DbValue = RsRow("banner_link")
		banner_sort.DbValue = RsRow("banner_sort")
	...
	Sub RenderListRow()
		...
		banner_id.ViewValue = banner_id.CurrentValue
		banner_id.ViewCustomAttributes = ""

		' banner_img
		banner_img.ViewValue = banner_img.CurrentValue
		banner_img.ViewCustomAttributes = ""

		' banner_link
		banner_link.ViewValue = banner_link.CurrentValue
		banner_link.ViewCustomAttributes = ""

		' banner_sort
		banner_sort.ViewValue = banner_sort.CurrentValue
		banner_sort.ViewCustomAttributes = ""
		...
		' banner_id
		banner_id.LinkCustomAttributes = ""
		banner_id.HrefValue = ""
		banner_id.TooltipValue = ""

		' banner_img
		banner_img.LinkCustomAttributes = ""
		banner_img.HrefValue = ""
		banner_img.TooltipValue = ""

		' banner_link
		banner_link.LinkCustomAttributes = ""
		banner_link.HrefValue = ""
		banner_link.TooltipValue = ""

		' banner_sort
		banner_sort.LinkCustomAttributes = ""
		banner_sort.HrefValue = ""
		banner_sort.TooltipValue = ""
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [banner_logo_01_th] WHERE " & sWhereList
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					Call XmlDoc.AddField("banner_id", banner_id.ExportValue(Export))
					Call XmlDoc.AddField("banner_img", banner_img.ExportValue(Export))
					Call XmlDoc.AddField("banner_link", banner_link.ExportValue(Export))
					Call XmlDoc.AddField("banner_sort", banner_sort.ExportValue(Export))
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				If banner_id.Exportable Then Call Doc.ExportCaption(banner_id)
				If banner_img.Exportable Then Call Doc.ExportCaption(banner_img)
				If banner_link.Exportable Then Call Doc.ExportCaption(banner_link)
				If banner_sort.Exportable Then Call Doc.ExportCaption(banner_sort)
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					If banner_id.Exportable Then Call Doc.ExportField(banner_id)
					If banner_img.Exportable Then Call Doc.ExportField(banner_img)
					If banner_link.Exportable Then Call Doc.ExportField(banner_link)
					If banner_sort.Exportable Then Call Doc.ExportField(banner_sort)
...
'			End If
	...
	Public Property Get banner_id()
		If Not IsObject(m_banner_id) Then
			Set m_banner_id = NewFldObj("banner_logo_01_th", "banner_logo_01_th", "x_banner_id", "banner_id", "[banner_id]", "[banner_id]", 3, 0, "[banner_id]", False, False, FALSE, "FORMATTED TEXT")
			m_banner_id.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set banner_id = m_banner_id
	End Property

	' Field banner_img
	Private m_banner_img

	Public Property Get banner_img()
		If Not IsObject(m_banner_img) Then
			Set m_banner_img = NewFldObj("banner_logo_01_th", "banner_logo_01_th", "x_banner_img", "banner_img", "[banner_img]", "[banner_img]", 202, 0, "[banner_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set banner_img = m_banner_img
	End Property

	' Field banner_link
	Private m_banner_link

	Public Property Get banner_link()
		If Not IsObject(m_banner_link) Then
			Set m_banner_link = NewFldObj("banner_logo_01_th", "banner_logo_01_th", "x_banner_link", "banner_link", "[banner_link]", "[banner_link]", 202, 0, "[banner_link]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set banner_link = m_banner_link
	End Property

	' Field banner_sort
	Private m_banner_sort

	Public Property Get banner_sort()
		If Not IsObject(m_banner_sort) Then
			Set m_banner_sort = NewFldObj("banner_logo_01_th", "banner_logo_01_th", "x_banner_sort", "banner_sort", "[banner_sort]", "[banner_sort]", 3, 0, "[banner_sort]", False, False, FALSE, "FORMATTED TEXT")
			m_banner_sort.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set banner_sort = m_banner_sort
	End Property
	...
	Public Property Get start_date()
		If Not IsObject(m_start_date) Then
			Set m_start_date = NewFldObj("banner_logo_01_th", "banner_logo_01_th", "x_start_date", "start_date", "[start_date]", "FORMAT([start_date], '')", 135, 8, "[start_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get end_date()
		If Not IsObject(m_end_date) Then
			Set m_end_date = NewFldObj("banner_logo_01_th", "banner_logo_01_th", "x_end_date", "end_date", "[end_date]", "FORMAT([end_date], '')", 135, 8, "[end_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Private Sub Class_Terminate
		If IsObject(m_banner_id) Then Set m_banner_id = Nothing
		If IsObject(m_banner_img) Then Set m_banner_img = Nothing
		If IsObject(m_banner_link) Then Set m_banner_link = Nothing
		If IsObject(m_banner_sort) Then Set m_banner_sort = Nothing
