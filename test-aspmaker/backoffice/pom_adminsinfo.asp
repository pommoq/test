...
' ASPMaker configuration for Table admins
Dim admins
...
Class cadmins
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "admin_id", admin_id)
		Call ew_SetArObj(Fields, "admin_username", admin_username)
		Call ew_SetArObj(Fields, "admin_password", admin_password)
		Call ew_SetArObj(Fields, "admin_name", admin_name)
		Call ew_SetArObj(Fields, "admin_email", admin_email)
		Call ew_SetArObj(Fields, "admin_tel", admin_tel)
		Call ew_SetArObj(Fields, "admin_permis", admin_permis)
		Call ew_SetArObj(Fields, "admin_create", admin_create)
		Call ew_SetArObj(Fields, "admin_update", admin_update)
		Call ew_SetArObj(Fields, "last_online", last_online)
	End Sub
	...
	Public Property Get HighlightName()
		HighlightName = "admins_Highlight"
	End Property
	...
	Private Property Get SqlKeyFilter()
		SqlKeyFilter = "[admin_id] = @admin_id@"
	End Property
	...
	Public Property Get KeyFilter()
		...
		If Not IsNumeric(admin_id.CurrentValue) Then
			sKeyFilter = "0=1" ' Invalid key
		End If
		sKeyFilter = Replace(sKeyFilter, "@admin_id@", ew_AdjustSql(admin_id.CurrentValue)) ' Replace key value
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_adminslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_adminslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_adminsview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_adminsview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_adminsedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_adminsadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_adminsdelete.asp", UrlParm(""))
	End Function
	...
	Public Function KeyUrl(url, parm)
		...
		If Not IsNull(admin_id.CurrentValue) Then
			sUrl = sUrl & "admin_id=" & admin_id.CurrentValue
		Else
	...
	Public Function GetRecordKeys()
		...
		If Not bHasKey Then
			...
			ElseIf Request.QueryString <> "" Then
				ReDim arKeys(0)
				arKeys(0) = Request.QueryString("admin_id") ' admin_id
	...
	Public Sub LoadListRowValues(RsRow)
		admin_id.DbValue = RsRow("admin_id")
		admin_username.DbValue = RsRow("admin_username")
		admin_password.DbValue = RsRow("admin_password")
		admin_name.DbValue = RsRow("admin_name")
		admin_email.DbValue = RsRow("admin_email")
		admin_tel.DbValue = RsRow("admin_tel")
		admin_permis.DbValue = RsRow("admin_permis")
		admin_create.DbValue = RsRow("admin_create")
		admin_update.DbValue = RsRow("admin_update")
		last_online.DbValue = RsRow("last_online")
	End Sub
	...
	Sub RenderListRow()
		...
		admin_id.ViewValue = admin_id.CurrentValue
		admin_id.ViewCustomAttributes = ""

		' admin_username
		admin_username.ViewValue = admin_username.CurrentValue
		admin_username.ViewCustomAttributes = ""

		' admin_password
		admin_password.ViewValue = admin_password.CurrentValue
		admin_password.ViewCustomAttributes = ""

		' admin_name
		admin_name.ViewValue = admin_name.CurrentValue
		admin_name.ViewCustomAttributes = ""

		' admin_email
		admin_email.ViewValue = admin_email.CurrentValue
		admin_email.ViewCustomAttributes = ""

		' admin_tel
		admin_tel.ViewValue = admin_tel.CurrentValue
		admin_tel.ViewCustomAttributes = ""

		' admin_permis
		admin_permis.ViewValue = admin_permis.CurrentValue
		admin_permis.ViewCustomAttributes = ""

		' admin_create
		admin_create.ViewValue = admin_create.CurrentValue
		admin_create.ViewCustomAttributes = ""

		' admin_update
		admin_update.ViewValue = admin_update.CurrentValue
		admin_update.ViewCustomAttributes = ""

		' last_online
		last_online.ViewValue = last_online.CurrentValue
		last_online.ViewCustomAttributes = ""

		' admin_id
		admin_id.LinkCustomAttributes = ""
		admin_id.HrefValue = ""
		admin_id.TooltipValue = ""

		' admin_username
		admin_username.LinkCustomAttributes = ""
		admin_username.HrefValue = ""
		admin_username.TooltipValue = ""

		' admin_password
		admin_password.LinkCustomAttributes = ""
		admin_password.HrefValue = ""
		admin_password.TooltipValue = ""

		' admin_name
		admin_name.LinkCustomAttributes = ""
		admin_name.HrefValue = ""
		admin_name.TooltipValue = ""

		' admin_email
		admin_email.LinkCustomAttributes = ""
		admin_email.HrefValue = ""
		admin_email.TooltipValue = ""

		' admin_tel
		admin_tel.LinkCustomAttributes = ""
		admin_tel.HrefValue = ""
		admin_tel.TooltipValue = ""

		' admin_permis
		admin_permis.LinkCustomAttributes = ""
		admin_permis.HrefValue = ""
		admin_permis.TooltipValue = ""

		' admin_create
		admin_create.LinkCustomAttributes = ""
		admin_create.HrefValue = ""
		admin_create.TooltipValue = ""

		' admin_update
		admin_update.LinkCustomAttributes = ""
		admin_update.HrefValue = ""
		admin_update.TooltipValue = ""

		' last_online
		last_online.LinkCustomAttributes = ""
		last_online.HrefValue = ""
		last_online.TooltipValue = ""
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [admins] WHERE " & sWhereList
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					Call XmlDoc.AddField("admin_id", admin_id.ExportValue(Export))
					Call XmlDoc.AddField("admin_username", admin_username.ExportValue(Export))
					Call XmlDoc.AddField("admin_password", admin_password.ExportValue(Export))
					Call XmlDoc.AddField("admin_name", admin_name.ExportValue(Export))
					Call XmlDoc.AddField("admin_email", admin_email.ExportValue(Export))
					Call XmlDoc.AddField("admin_tel", admin_tel.ExportValue(Export))
					Call XmlDoc.AddField("admin_permis", admin_permis.ExportValue(Export))
					Call XmlDoc.AddField("admin_create", admin_create.ExportValue(Export))
					Call XmlDoc.AddField("admin_update", admin_update.ExportValue(Export))
					Call XmlDoc.AddField("last_online", last_online.ExportValue(Export))
				Else
					Call XmlDoc.AddField("admin_id", admin_id.ExportValue(Export))
					Call XmlDoc.AddField("admin_username", admin_username.ExportValue(Export))
					Call XmlDoc.AddField("admin_password", admin_password.ExportValue(Export))
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				If admin_id.Exportable Then Call Doc.ExportCaption(admin_id)
				If admin_username.Exportable Then Call Doc.ExportCaption(admin_username)
				If admin_password.Exportable Then Call Doc.ExportCaption(admin_password)
				If admin_name.Exportable Then Call Doc.ExportCaption(admin_name)
				If admin_email.Exportable Then Call Doc.ExportCaption(admin_email)
				If admin_tel.Exportable Then Call Doc.ExportCaption(admin_tel)
				If admin_permis.Exportable Then Call Doc.ExportCaption(admin_permis)
				If admin_create.Exportable Then Call Doc.ExportCaption(admin_create)
				If admin_update.Exportable Then Call Doc.ExportCaption(admin_update)
				If last_online.Exportable Then Call Doc.ExportCaption(last_online)
			Else
				If admin_id.Exportable Then Call Doc.ExportCaption(admin_id)
				If admin_username.Exportable Then Call Doc.ExportCaption(admin_username)
				If admin_password.Exportable Then Call Doc.ExportCaption(admin_password)
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					If admin_id.Exportable Then Call Doc.ExportField(admin_id)
					If admin_username.Exportable Then Call Doc.ExportField(admin_username)
					If admin_password.Exportable Then Call Doc.ExportField(admin_password)
					If admin_name.Exportable Then Call Doc.ExportField(admin_name)
					If admin_email.Exportable Then Call Doc.ExportField(admin_email)
					If admin_tel.Exportable Then Call Doc.ExportField(admin_tel)
					If admin_permis.Exportable Then Call Doc.ExportField(admin_permis)
					If admin_create.Exportable Then Call Doc.ExportField(admin_create)
					If admin_update.Exportable Then Call Doc.ExportField(admin_update)
					If last_online.Exportable Then Call Doc.ExportField(last_online)
				Else
					If admin_id.Exportable Then Call Doc.ExportField(admin_id)
					If admin_username.Exportable Then Call Doc.ExportField(admin_username)
					If admin_password.Exportable Then Call Doc.ExportField(admin_password)
...
'			End If
	...
	Public Property Get admin_id()
		If Not IsObject(m_admin_id) Then
			Set m_admin_id = NewFldObj("admins", "admins", "x_admin_id", "admin_id", "[admin_id]", "[admin_id]", 3, 0, "[admin_id]", False, False, FALSE, "FORMATTED TEXT")
			m_admin_id.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set admin_id = m_admin_id
	End Property

	' Field admin_username
	Private m_admin_username

	Public Property Get admin_username()
		If Not IsObject(m_admin_username) Then
			Set m_admin_username = NewFldObj("admins", "admins", "x_admin_username", "admin_username", "[admin_username]", "[admin_username]", 202, 0, "[admin_username]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_username = m_admin_username
	End Property

	' Field admin_password
	Private m_admin_password

	Public Property Get admin_password()
		If Not IsObject(m_admin_password) Then
			Set m_admin_password = NewFldObj("admins", "admins", "x_admin_password", "admin_password", "[admin_password]", "[admin_password]", 202, 0, "[admin_password]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_password = m_admin_password
	End Property

	' Field admin_name
	Private m_admin_name

	Public Property Get admin_name()
		If Not IsObject(m_admin_name) Then
			Set m_admin_name = NewFldObj("admins", "admins", "x_admin_name", "admin_name", "[admin_name]", "[admin_name]", 202, 0, "[admin_name]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_name = m_admin_name
	End Property

	' Field admin_email
	Private m_admin_email

	Public Property Get admin_email()
		If Not IsObject(m_admin_email) Then
			Set m_admin_email = NewFldObj("admins", "admins", "x_admin_email", "admin_email", "[admin_email]", "[admin_email]", 202, 0, "[admin_email]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_email = m_admin_email
	End Property

	' Field admin_tel
	Private m_admin_tel

	Public Property Get admin_tel()
		If Not IsObject(m_admin_tel) Then
			Set m_admin_tel = NewFldObj("admins", "admins", "x_admin_tel", "admin_tel", "[admin_tel]", "[admin_tel]", 202, 0, "[admin_tel]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_tel = m_admin_tel
	End Property

	' Field admin_permis
	Private m_admin_permis

	Public Property Get admin_permis()
		If Not IsObject(m_admin_permis) Then
			Set m_admin_permis = NewFldObj("admins", "admins", "x_admin_permis", "admin_permis", "[admin_permis]", "[admin_permis]", 202, 0, "[admin_permis]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_permis = m_admin_permis
	End Property

	' Field admin_create
	Private m_admin_create

	Public Property Get admin_create()
		If Not IsObject(m_admin_create) Then
			Set m_admin_create = NewFldObj("admins", "admins", "x_admin_create", "admin_create", "[admin_create]", "FORMAT([admin_create], '')", 135, 8, "[admin_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_create = m_admin_create
	End Property

	' Field admin_update
	Private m_admin_update

	Public Property Get admin_update()
		If Not IsObject(m_admin_update) Then
			Set m_admin_update = NewFldObj("admins", "admins", "x_admin_update", "admin_update", "[admin_update]", "FORMAT([admin_update], '')", 135, 8, "[admin_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set admin_update = m_admin_update
	End Property

	' Field last_online
	Private m_last_online

	Public Property Get last_online()
		If Not IsObject(m_last_online) Then
			Set m_last_online = NewFldObj("admins", "admins", "x_last_online", "last_online", "[last_online]", "FORMAT([last_online], '')", 135, 8, "[last_online]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set last_online = m_last_online
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		If IsObject(m_admin_id) Then Set m_admin_id = Nothing
		If IsObject(m_admin_username) Then Set m_admin_username = Nothing
		If IsObject(m_admin_password) Then Set m_admin_password = Nothing
		If IsObject(m_admin_name) Then Set m_admin_name = Nothing
		If IsObject(m_admin_email) Then Set m_admin_email = Nothing
		If IsObject(m_admin_tel) Then Set m_admin_tel = Nothing
		If IsObject(m_admin_permis) Then Set m_admin_permis = Nothing
		If IsObject(m_admin_create) Then Set m_admin_create = Nothing
		If IsObject(m_admin_update) Then Set m_admin_update = Nothing
		If IsObject(m_last_online) Then Set m_last_online = Nothing
