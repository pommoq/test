...
' Define page object
Dim company_view
Set company_view = New ccompany_view
Set Page = company_view
...
// Form object
var fcompanyview = new ew_Form("fcompanyview");
...
fcompanyview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fcompanyview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% company_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not company_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	company_view.ActionOptions.Render "body", "", "", "", "", ""
	company_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% company_view.ShowPageHeader() %>
<% company_view.ShowMessage %>
<form name="fcompanyview" id="fcompanyview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="company">
<table class="ewGrid"><tr><td>
<table id="tbl_companyview" class="table table-bordered table-striped">
...
<%= company.company_name_en.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= company.company_name_th.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= company.company_create.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= company.company_update.ViewValue %>
</span>
</span>
</td>
	</tr>
...
Class ccompany_view
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_companylist.asp" ' Return to list
			End If
			...
			Select Case company.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_companylist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_companylist.asp" ' Not page request, return to list
		End If
