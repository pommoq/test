...
' Define page object
Dim z40news_add
Set z40news_add = New cz40news_add
Set Page = z40news_add

' Page init processing
z40news_add.Page_Init()

' Page main processing
z40news_add.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
z40news_add.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var z40news_add = new ew_Page("z40news_add");
z40news_add.PageID = "add"; // Page ID
var EW_PAGE_ID = z40news_add.PageID; // For backward compatibility
// Form object
var fz40newsadd = new ew_Form("fz40newsadd");
// Validate form
fz40newsadd.Validate = function() {
...
fz40newsadd.Form_CustomValidate = 
...
fz40newsadd.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fz40newsadd.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% z40news_add.ShowPageHeader() %>
<% z40news_add.ShowMessage %>
<form name="fz40newsadd" id="fz40newsadd" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="z40news">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_z40newsadd" class="table table-bordered table-striped">
...
Class cz40news_add
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			z40news.CurrentAction = ObjForm.GetValue("a_add") ' Get form action
		...
		Else
			...
			If Request.QueryString("news_id").Count > 0 Then
				...
				Call z40news.SetKey("news_id", z40news.news_id.CurrentValue) ' Set up key
			Else
				Call z40news.SetKey("news_id", "") ' Clear key
				CopyRecord = False
			End If
			If CopyRecord Then
				z40news.CurrentAction = "C" ' Copy Record
			Else
				z40news.CurrentAction = "I" ' Display Blank Record
		...
		If ObjForm.GetValue("a_add")&"" <> "" Then
			If Not ValidateForm() Then
				z40news.CurrentAction = "I" ' Form error, reset action
		...
		Select Case z40news.CurrentAction
			...
			Case "A" ' Add new record
				z40news.SendEmail = True ' Send email on add success
				If AddRow(OldRecordset) Then ' Add successful
					SuccessMessage = Language.Phrase("AddSuccess") ' Set up success message
					Dim sReturnUrl
					sReturnUrl = z40news.ReturnUrl
					If ew_GetPageName(sReturnUrl) = "pom_z40newsview.asp" Then sReturnUrl = z40news.ViewUrl("") ' View paging, return to view page with keyurl directly
		...
		z40news.RowType = EW_ROWTYPE_ADD ' Render add type
	...
	Function LoadDefaultValues()
		z40news.news_img.CurrentValue = Null
		z40news.news_img.OldValue = z40news.news_img.CurrentValue
		z40news.news_category.CurrentValue = Null
		z40news.news_category.OldValue = z40news.news_category.CurrentValue
		z40news.news_subject.CurrentValue = Null
		z40news.news_subject.OldValue = z40news.news_subject.CurrentValue
		z40news.news_subject_th.CurrentValue = Null
		z40news.news_subject_th.OldValue = z40news.news_subject_th.CurrentValue
		z40news.news_intro.CurrentValue = Null
		z40news.news_intro.OldValue = z40news.news_intro.CurrentValue
		z40news.news_intro_th.CurrentValue = Null
		z40news.news_intro_th.OldValue = z40news.news_intro_th.CurrentValue
		z40news.news_content.CurrentValue = Null
		z40news.news_content.OldValue = z40news.news_content.CurrentValue
		z40news.news_content_th.CurrentValue = Null
		z40news.news_content_th.OldValue = z40news.news_content_th.CurrentValue
		z40news.news_show_en.CurrentValue = Null
		z40news.news_show_en.OldValue = z40news.news_show_en.CurrentValue
		z40news.news_show.CurrentValue = Null
		z40news.news_show.OldValue = z40news.news_show.CurrentValue
		z40news.news_create.CurrentValue = Null
		z40news.news_create.OldValue = z40news.news_create.CurrentValue
		z40news.news_update.CurrentValue = Null
		z40news.news_update.OldValue = z40news.news_update.CurrentValue
	End Function
	...
	Sub RenderRow()
		...
		ElseIf z40news.RowType = EW_ROWTYPE_ADD Then ' Add row
	...
	Function AddRow(RsOld)
		...
		' Field news_img
		Call z40news.news_img.SetDbValue(Rs, z40news.news_img.CurrentValue, Null, False)

		' Field news_category
		Call z40news.news_category.SetDbValue(Rs, z40news.news_category.CurrentValue, Null, False)

		' Field news_subject
		Call z40news.news_subject.SetDbValue(Rs, z40news.news_subject.CurrentValue, Null, False)

		' Field news_subject_th
		Call z40news.news_subject_th.SetDbValue(Rs, z40news.news_subject_th.CurrentValue, Null, False)

		' Field news_intro
		Call z40news.news_intro.SetDbValue(Rs, z40news.news_intro.CurrentValue, Null, False)

		' Field news_intro_th
		Call z40news.news_intro_th.SetDbValue(Rs, z40news.news_intro_th.CurrentValue, Null, False)

		' Field news_content
		Call z40news.news_content.SetDbValue(Rs, z40news.news_content.CurrentValue, Null, False)

		' Field news_content_th
		Call z40news.news_content_th.SetDbValue(Rs, z40news.news_content_th.CurrentValue, Null, False)

		' Field news_show_en
		Call z40news.news_show_en.SetDbValue(Rs, z40news.news_show_en.CurrentValue, Null, False)

		' Field news_show
		Call z40news.news_show.SetDbValue(Rs, z40news.news_show.CurrentValue, Null, False)

		' Field news_create
		Call z40news.news_create.SetDbValue(Rs, z40news.news_create.CurrentValue, Null, False)

		' Field news_update
		Call z40news.news_update.SetDbValue(Rs, z40news.news_update.CurrentValue, Null, False)
		...
		bInsertRow = z40news.Row_Inserting(RsOld, Rs)
		If bInsertRow Then
		...
		Set Rs = Nothing
		If AddRow Then
			z40news.news_id.DbValue = RsNew("news_id")
		End If
		If AddRow Then

			' Call Row Inserted event
			Call z40news.Row_Inserted(RsOld, RsNew)
		End If
	...
	Sub SetupBreadcrumb()
		...
		PageId = ew_IIf(z40news.CurrentAction = "C", "Copy", "Add")
