...
' Define page object
Dim vehicle_record_delete
Set vehicle_record_delete = New cvehicle_record_delete
Set Page = vehicle_record_delete

' Page init processing
vehicle_record_delete.Page_Init()

' Page main processing
vehicle_record_delete.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
vehicle_record_delete.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var vehicle_record_delete = new ew_Page("vehicle_record_delete");
vehicle_record_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = vehicle_record_delete.PageID; // For backward compatibility
// Form object
var fvehicle_recorddelete = new ew_Form("fvehicle_recorddelete");
// Form_CustomValidate event
fvehicle_recorddelete.Form_CustomValidate = 
...
fvehicle_recorddelete.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fvehicle_recorddelete.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
Set vehicle_record_delete.Recordset = vehicle_record_delete.LoadRecordset()
vehicle_record_delete.TotalRecs = vehicle_record_delete.Recordset.RecordCount ' Get record count
If vehicle_record_delete.TotalRecs <= 0 Then ' No record found, exit
	vehicle_record_delete.Recordset.Close
	Set vehicle_record_delete.Recordset = Nothing
	Call vehicle_record_delete.Page_Terminate("pom_vehicle_recordlist.asp") ' Return to list
End If
%>
<% If vehicle_record.Export = "" Then %>
<% Breadcrumb.Render() %>
<% End If %>
<% vehicle_record_delete.ShowPageHeader() %>
<% vehicle_record_delete.ShowMessage %>
<form name="fvehicle_recorddelete" id="fvehicle_recorddelete" class="ewForm form-inline" action="<%= ew_CurrentPage() %>" method="post">
<input type="hidden" name="t" value="vehicle_record">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<% For i = 0 to UBound(vehicle_record_delete.RecKeys) %>
<input type="hidden" name="key_m" id="key_m" value="<%= ew_HtmlEncode(ew_GetKeyValue(vehicle_record_delete.RecKeys(i))) %>">
<% Next %>
<table class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_vehicle_recorddelete" class="ewTable ewTableSeparate">
<%= vehicle_record.TableCustomInnerHtml %>
	<thead>
	<tr class="ewTableHeader">
<% If vehicle_record.veh_id.Visible Then ' veh_id %>
		<td><span id="elh_vehicle_record_veh_id" class="vehicle_record_veh_id"><%= vehicle_record.veh_id.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.vch_month.Visible Then ' vch_month %>
		<td><span id="elh_vehicle_record_vch_month" class="vehicle_record_vch_month"><%= vehicle_record.vch_month.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.vch_year.Visible Then ' vch_year %>
		<td><span id="elh_vehicle_record_vch_year" class="vehicle_record_vch_year"><%= vehicle_record.vch_year.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_1.Visible Then ' veh_product_1 %>
		<td><span id="elh_vehicle_record_veh_product_1" class="vehicle_record_veh_product_1"><%= vehicle_record.veh_product_1.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_2.Visible Then ' veh_product_2 %>
		<td><span id="elh_vehicle_record_veh_product_2" class="vehicle_record_veh_product_2"><%= vehicle_record.veh_product_2.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_3.Visible Then ' veh_product_3 %>
		<td><span id="elh_vehicle_record_veh_product_3" class="vehicle_record_veh_product_3"><%= vehicle_record.veh_product_3.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_4.Visible Then ' veh_product_4 %>
		<td><span id="elh_vehicle_record_veh_product_4" class="vehicle_record_veh_product_4"><%= vehicle_record.veh_product_4.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_5.Visible Then ' veh_product_5 %>
		<td><span id="elh_vehicle_record_veh_product_5" class="vehicle_record_veh_product_5"><%= vehicle_record.veh_product_5.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_6.Visible Then ' veh_product_6 %>
		<td><span id="elh_vehicle_record_veh_product_6" class="vehicle_record_veh_product_6"><%= vehicle_record.veh_product_6.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_7.Visible Then ' veh_product_7 %>
		<td><span id="elh_vehicle_record_veh_product_7" class="vehicle_record_veh_product_7"><%= vehicle_record.veh_product_7.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_product_8.Visible Then ' veh_product_8 %>
		<td><span id="elh_vehicle_record_veh_product_8" class="vehicle_record_veh_product_8"><%= vehicle_record.veh_product_8.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_1.Visible Then ' veh_domes_1 %>
		<td><span id="elh_vehicle_record_veh_domes_1" class="vehicle_record_veh_domes_1"><%= vehicle_record.veh_domes_1.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_2.Visible Then ' veh_domes_2 %>
		<td><span id="elh_vehicle_record_veh_domes_2" class="vehicle_record_veh_domes_2"><%= vehicle_record.veh_domes_2.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_3.Visible Then ' veh_domes_3 %>
		<td><span id="elh_vehicle_record_veh_domes_3" class="vehicle_record_veh_domes_3"><%= vehicle_record.veh_domes_3.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_4.Visible Then ' veh_domes_4 %>
		<td><span id="elh_vehicle_record_veh_domes_4" class="vehicle_record_veh_domes_4"><%= vehicle_record.veh_domes_4.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_5.Visible Then ' veh_domes_5 %>
		<td><span id="elh_vehicle_record_veh_domes_5" class="vehicle_record_veh_domes_5"><%= vehicle_record.veh_domes_5.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_6.Visible Then ' veh_domes_6 %>
		<td><span id="elh_vehicle_record_veh_domes_6" class="vehicle_record_veh_domes_6"><%= vehicle_record.veh_domes_6.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_7.Visible Then ' veh_domes_7 %>
		<td><span id="elh_vehicle_record_veh_domes_7" class="vehicle_record_veh_domes_7"><%= vehicle_record.veh_domes_7.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_domes_8.Visible Then ' veh_domes_8 %>
		<td><span id="elh_vehicle_record_veh_domes_8" class="vehicle_record_veh_domes_8"><%= vehicle_record.veh_domes_8.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_1.Visible Then ' veh_export_1 %>
		<td><span id="elh_vehicle_record_veh_export_1" class="vehicle_record_veh_export_1"><%= vehicle_record.veh_export_1.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_2.Visible Then ' veh_export_2 %>
		<td><span id="elh_vehicle_record_veh_export_2" class="vehicle_record_veh_export_2"><%= vehicle_record.veh_export_2.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_3.Visible Then ' veh_export_3 %>
		<td><span id="elh_vehicle_record_veh_export_3" class="vehicle_record_veh_export_3"><%= vehicle_record.veh_export_3.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_4.Visible Then ' veh_export_4 %>
		<td><span id="elh_vehicle_record_veh_export_4" class="vehicle_record_veh_export_4"><%= vehicle_record.veh_export_4.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_5.Visible Then ' veh_export_5 %>
		<td><span id="elh_vehicle_record_veh_export_5" class="vehicle_record_veh_export_5"><%= vehicle_record.veh_export_5.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_6.Visible Then ' veh_export_6 %>
		<td><span id="elh_vehicle_record_veh_export_6" class="vehicle_record_veh_export_6"><%= vehicle_record.veh_export_6.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_7.Visible Then ' veh_export_7 %>
		<td><span id="elh_vehicle_record_veh_export_7" class="vehicle_record_veh_export_7"><%= vehicle_record.veh_export_7.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_export_8.Visible Then ' veh_export_8 %>
		<td><span id="elh_vehicle_record_veh_export_8" class="vehicle_record_veh_export_8"><%= vehicle_record.veh_export_8.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_month_title.Visible Then ' veh_month_title %>
		<td><span id="elh_vehicle_record_veh_month_title" class="vehicle_record_veh_month_title"><%= vehicle_record.veh_month_title.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_range.Visible Then ' veh_range %>
		<td><span id="elh_vehicle_record_veh_range" class="vehicle_record_veh_range"><%= vehicle_record.veh_range.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_month_title2.Visible Then ' veh_month_title2 %>
		<td><span id="elh_vehicle_record_veh_month_title2" class="vehicle_record_veh_month_title2"><%= vehicle_record.veh_month_title2.FldCaption %></span></td>
<% End If %>
<% If vehicle_record.veh_range2.Visible Then ' veh_range2 %>
		<td><span id="elh_vehicle_record_veh_range2" class="vehicle_record_veh_range2"><%= vehicle_record.veh_range2.FldCaption %></span></td>
<% End If %>
	</tr>
	</thead>
	<tbody>
<%
vehicle_record_delete.RecCnt = 0
vehicle_record_delete.RowCnt = 0
Do While (Not vehicle_record_delete.Recordset.Eof)
	vehicle_record_delete.RecCnt = vehicle_record_delete.RecCnt + 1
	vehicle_record_delete.RowCnt = vehicle_record_delete.RowCnt + 1

	' Set row properties
	Call vehicle_record.ResetAttrs()
	vehicle_record.RowType = EW_ROWTYPE_VIEW ' view

	' Get the field contents
	Call vehicle_record_delete.LoadRowValues(vehicle_record_delete.Recordset)

	' Render row
	Call vehicle_record_delete.RenderRow()
%>
	<tr<%= vehicle_record.RowAttributes %>>
<% If vehicle_record.veh_id.Visible Then ' veh_id %>
		<td<%= vehicle_record.veh_id.CellAttributes %>>
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_id" class="control-group vehicle_record_veh_id">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_vch_month" class="control-group vehicle_record_vch_month">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_vch_year" class="control-group vehicle_record_vch_year">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_1" class="control-group vehicle_record_veh_product_1">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_2" class="control-group vehicle_record_veh_product_2">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_3" class="control-group vehicle_record_veh_product_3">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_4" class="control-group vehicle_record_veh_product_4">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_5" class="control-group vehicle_record_veh_product_5">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_6" class="control-group vehicle_record_veh_product_6">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_7" class="control-group vehicle_record_veh_product_7">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_product_8" class="control-group vehicle_record_veh_product_8">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_1" class="control-group vehicle_record_veh_domes_1">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_2" class="control-group vehicle_record_veh_domes_2">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_3" class="control-group vehicle_record_veh_domes_3">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_4" class="control-group vehicle_record_veh_domes_4">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_5" class="control-group vehicle_record_veh_domes_5">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_6" class="control-group vehicle_record_veh_domes_6">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_7" class="control-group vehicle_record_veh_domes_7">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_domes_8" class="control-group vehicle_record_veh_domes_8">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_1" class="control-group vehicle_record_veh_export_1">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_2" class="control-group vehicle_record_veh_export_2">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_3" class="control-group vehicle_record_veh_export_3">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_4" class="control-group vehicle_record_veh_export_4">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_5" class="control-group vehicle_record_veh_export_5">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_6" class="control-group vehicle_record_veh_export_6">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_7" class="control-group vehicle_record_veh_export_7">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_export_8" class="control-group vehicle_record_veh_export_8">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_month_title" class="control-group vehicle_record_veh_month_title">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_range" class="control-group vehicle_record_veh_range">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_month_title2" class="control-group vehicle_record_veh_month_title2">
...
<span id="el<%= vehicle_record_delete.RowCnt %>_vehicle_record_veh_range2" class="control-group vehicle_record_veh_range2">
...
<%
	vehicle_record_delete.Recordset.MoveNext
Loop
vehicle_record_delete.Recordset.Close
Set vehicle_record_delete.Recordset = Nothing
%>
...
<script type="text/javascript">
fvehicle_recorddelete.Init();
</script>
<%
vehicle_record_delete.ShowPageFooter()
...
' Drop page object
Set vehicle_record_delete = Nothing
%>
<%
...
Class cvehicle_record_delete
	...
	Public Property Get PageObjName()
		PageObjName = "vehicle_record_delete"
	End Property
	...
	Sub Page_Main()
		...
		' Load Key Parameters
		RecKeys = vehicle_record.GetRecordKeys() ' Load record keys
		sFilter = vehicle_record.GetKeyFilter()
		If sFilter = "" Then
			Call Page_Terminate("pom_vehicle_recordlist.asp") ' Prevent SQL injection, return to list
		End If

		' Set up filter (Sql Where Clause) and get Return Sql
		' Sql constructor in vehicle_record class, vehicle_recordinfo.asp

		vehicle_record.CurrentFilter = sFilter

		' Get action
		If Request.Form("a_delete").Count > 0 Then
			vehicle_record.CurrentAction = Request.Form("a_delete")
		Else
			vehicle_record.CurrentAction = "I"	' Display record
		End If
		Select Case vehicle_record.CurrentAction
			Case "D" ' Delete
				vehicle_record.SendEmail = True ' Send email on delete success
				If DeleteRows() Then ' Delete rows
					SuccessMessage = Language.Phrase("DeleteSuccess") ' Set up success message
					Call Page_Terminate(vehicle_record.ReturnUrl) ' Return to caller
				End If
		End Select
	End Sub
	...
	Function DeleteRows()
		...
		If DeleteRows Then
			...
			Do While Not RsDelete.Eof
				DeleteRows = vehicle_record.Row_Deleting(RsDelete)
		...
		If DeleteRows Then
			...
			Do While Not RsOld.Eof
				Call vehicle_record.Row_Deleted(RsOld)
				RsOld.MoveNext
			Loop
		End If
		RsOld.Close
