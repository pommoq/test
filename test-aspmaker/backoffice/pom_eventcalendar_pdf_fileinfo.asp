...
' ASPMaker configuration for Table eventcalendar_pdf_file
Dim eventcalendar_pdf_file

' Define table class
Class ceventcalendar_pdf_file
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "eventcalendar_pdf_file_1", eventcalendar_pdf_file_1)
	...
	Public Property Get TableVar()
		TableVar = "eventcalendar_pdf_file"
	End Property
	...
	Public Property Get HighlightName()
		HighlightName = "eventcalendar_pdf_file_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [eventcalendar_pdf_file]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_eventcalendar_pdf_filelist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_eventcalendar_pdf_filelist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_eventcalendar_pdf_fileview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_eventcalendar_pdf_fileview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_eventcalendar_pdf_fileedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_eventcalendar_pdf_fileadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_eventcalendar_pdf_filedelete.asp", UrlParm(""))
	End Function
	...
	Function UrlParm(parm)
		If UseTokenInUrl Then
			UrlParm = "t=eventcalendar_pdf_file"
		Else
			UrlParm = ""
		End If
		If parm <> "" Then
	...
	Public Sub LoadListRowValues(RsRow)
		...
		eventcalendar_pdf_file_1.DbValue = RsRow("eventcalendar_pdf_file")
	...
	Sub RenderListRow()
		...
		' eventcalendar_pdf_file
		eventcalendar_pdf_file_1.ViewValue = eventcalendar_pdf_file_1.CurrentValue
		eventcalendar_pdf_file_1.ViewCustomAttributes = ""
		...
		' eventcalendar_pdf_file
		eventcalendar_pdf_file_1.LinkCustomAttributes = ""
		eventcalendar_pdf_file_1.HrefValue = ""
		eventcalendar_pdf_file_1.TooltipValue = ""
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [eventcalendar_pdf_file] WHERE " & sWhereList
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("eventcalendar_pdf_file_1", eventcalendar_pdf_file_1.ExportValue(Export))
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				...
				If eventcalendar_pdf_file_1.Exportable Then Call Doc.ExportCaption(eventcalendar_pdf_file_1)
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					If eventcalendar_pdf_file_1.Exportable Then Call Doc.ExportField(eventcalendar_pdf_file_1)
...
'			End If
	...
	Public Property Get eventcalendar_pdf_id()
		If Not IsObject(m_eventcalendar_pdf_id) Then
			Set m_eventcalendar_pdf_id = NewFldObj("eventcalendar_pdf_file", "eventcalendar_pdf_file", "x_eventcalendar_pdf_id", "eventcalendar_pdf_id", "[eventcalendar_pdf_id]", "[eventcalendar_pdf_id]", 3, 0, "[eventcalendar_pdf_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get eventcalendar_id()
		If Not IsObject(m_eventcalendar_id) Then
			Set m_eventcalendar_id = NewFldObj("eventcalendar_pdf_file", "eventcalendar_pdf_file", "x_eventcalendar_id", "eventcalendar_id", "[eventcalendar_id]", "[eventcalendar_id]", 3, 0, "[eventcalendar_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Private m_eventcalendar_pdf_file_1

	Public Property Get eventcalendar_pdf_file_1()
		If Not IsObject(m_eventcalendar_pdf_file_1) Then
			Set m_eventcalendar_pdf_file_1 = NewFldObj("eventcalendar_pdf_file", "eventcalendar_pdf_file", "x_eventcalendar_pdf_file_1", "eventcalendar_pdf_file", "[eventcalendar_pdf_file]", "[eventcalendar_pdf_file]", 202, 0, "[eventcalendar_pdf_file]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set eventcalendar_pdf_file_1 = m_eventcalendar_pdf_file_1
	End Property
	...
	Public Property Get eventcalendar_pdf_title()
		If Not IsObject(m_eventcalendar_pdf_title) Then
			Set m_eventcalendar_pdf_title = NewFldObj("eventcalendar_pdf_file", "eventcalendar_pdf_file", "x_eventcalendar_pdf_title", "eventcalendar_pdf_title", "[eventcalendar_pdf_title]", "[eventcalendar_pdf_title]", 202, 0, "[eventcalendar_pdf_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_eventcalendar_pdf_file_1) Then Set m_eventcalendar_pdf_file_1 = Nothing
