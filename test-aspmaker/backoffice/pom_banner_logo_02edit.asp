...
' Define page object
Dim banner_logo_02_edit
Set banner_logo_02_edit = New cbanner_logo_02_edit
Set Page = banner_logo_02_edit

' Page init processing
banner_logo_02_edit.Page_Init()

' Page main processing
banner_logo_02_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
banner_logo_02_edit.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var banner_logo_02_edit = new ew_Page("banner_logo_02_edit");
banner_logo_02_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = banner_logo_02_edit.PageID; // For backward compatibility
// Form object
var fbanner_logo_02edit = new ew_Form("fbanner_logo_02edit");
// Validate form
fbanner_logo_02edit.Validate = function() {
...
fbanner_logo_02edit.Form_CustomValidate = 
...
fbanner_logo_02edit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fbanner_logo_02edit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% banner_logo_02_edit.ShowPageHeader() %>
<% banner_logo_02_edit.ShowMessage %>
<form name="fbanner_logo_02edit" id="fbanner_logo_02edit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="a_table" id="a_table" value="banner_logo_02">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_banner_logo_02edit" class="table table-bordered table-striped">
...
<%= banner_logo_02.banner_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_banner_id" name="x_banner_id" id="x_banner_id" value="<%= Server.HTMLEncode(banner_logo_02.banner_id.CurrentValue&"") %>">
...
<script type="text/javascript">
fbanner_logo_02edit.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
banner_logo_02_edit.ShowPageFooter()
...
' Drop page object
Set banner_logo_02_edit = Nothing
%>
<%
...
Class cbanner_logo_02_edit
	...
	Public Property Get PageObjName()
		PageObjName = "banner_logo_02_edit"
	End Property
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			banner_logo_02.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			banner_logo_02.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If banner_logo_02.banner_id.CurrentValue = "" Then Call Page_Terminate("pom_banner_logo_02list.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				banner_logo_02.CurrentAction = "" ' Form error, reset action
		...
		Select Case banner_logo_02.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				banner_logo_02.SendEmail = True ' Send email on update success
		...
		' Render the record
		banner_logo_02.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Sub RenderRow()
		...
		ElseIf banner_logo_02.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' banner_id
			banner_logo_02.banner_id.EditCustomAttributes = ""
			banner_logo_02.banner_id.EditValue = banner_logo_02.banner_id.CurrentValue
			banner_logo_02.banner_id.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			Call banner_logo_02.banner_img.SetDbValue(Rs, banner_logo_02.banner_img.CurrentValue, Null, banner_logo_02.banner_img.ReadOnly)

			' Field banner_link
			Call banner_logo_02.banner_link.SetDbValue(Rs, banner_logo_02.banner_link.CurrentValue, Null, banner_logo_02.banner_link.ReadOnly)

			' Field banner_sort
			Call banner_logo_02.banner_sort.SetDbValue(Rs, banner_logo_02.banner_sort.CurrentValue, Null, banner_logo_02.banner_sort.ReadOnly)

			' Field start_date
			Call banner_logo_02.start_date.SetDbValue(Rs, banner_logo_02.start_date.CurrentValue, Null, banner_logo_02.start_date.ReadOnly)

			' Field end_date
			Call banner_logo_02.end_date.SetDbValue(Rs, banner_logo_02.end_date.CurrentValue, Null, banner_logo_02.end_date.ReadOnly)
			...
			bUpdateRow = banner_logo_02.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call banner_logo_02.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
