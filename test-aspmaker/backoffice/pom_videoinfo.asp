...
' ASPMaker configuration for Table video
Dim video
...
Class cvideo
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_videolist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_videolist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_videoview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_videoview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_videoedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_videoadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_videodelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [video] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get video_id()
		If Not IsObject(m_video_id) Then
			Set m_video_id = NewFldObj("video", "video", "x_video_id", "video_id", "[video_id]", "[video_id]", 3, 0, "[video_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get video_title()
		If Not IsObject(m_video_title) Then
			Set m_video_title = NewFldObj("video", "video", "x_video_title", "video_title", "[video_title]", "[video_title]", 202, 0, "[video_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get video_link()
		If Not IsObject(m_video_link) Then
			Set m_video_link = NewFldObj("video", "video", "x_video_link", "video_link", "[video_link]", "[video_link]", 202, 0, "[video_link]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get video_detail()
		If Not IsObject(m_video_detail) Then
			Set m_video_detail = NewFldObj("video", "video", "x_video_detail", "video_detail", "[video_detail]", "[video_detail]", 203, 0, "[video_detail]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get video_create()
		If Not IsObject(m_video_create) Then
			Set m_video_create = NewFldObj("video", "video", "x_video_create", "video_create", "[video_create]", "FORMAT([video_create], '')", 135, 8, "[video_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get video_update()
		If Not IsObject(m_video_update) Then
			Set m_video_update = NewFldObj("video", "video", "x_video_update", "video_update", "[video_update]", "FORMAT([video_update], '')", 135, 8, "[video_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
