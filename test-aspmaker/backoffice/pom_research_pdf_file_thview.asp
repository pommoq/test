...
' Define page object
Dim research_pdf_file_th_view
Set research_pdf_file_th_view = New cresearch_pdf_file_th_view
Set Page = research_pdf_file_th_view

' Page init processing
research_pdf_file_th_view.Page_Init()

' Page main processing
research_pdf_file_th_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
research_pdf_file_th_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If research_pdf_file_th.Export = "" Then %>
<script type="text/javascript">
// Page object
var research_pdf_file_th_view = new ew_Page("research_pdf_file_th_view");
research_pdf_file_th_view.PageID = "view"; // Page ID
var EW_PAGE_ID = research_pdf_file_th_view.PageID; // For backward compatibility
// Form object
var fresearch_pdf_file_thview = new ew_Form("fresearch_pdf_file_thview");
// Form_CustomValidate event
fresearch_pdf_file_thview.Form_CustomValidate = 
...
fresearch_pdf_file_thview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fresearch_pdf_file_thview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% research_pdf_file_th_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not research_pdf_file_th_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	research_pdf_file_th_view.ActionOptions.Render "body", "", "", "", "", ""
	research_pdf_file_th_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% research_pdf_file_th_view.ShowPageHeader() %>
<% research_pdf_file_th_view.ShowMessage %>
<form name="fresearch_pdf_file_thview" id="fresearch_pdf_file_thview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="research_pdf_file_th">
<table class="ewGrid"><tr><td>
<table id="tbl_research_pdf_file_thview" class="table table-bordered table-striped">
...
<%= research_pdf_file_th.rsh_pdf_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= research_pdf_file_th.rsh_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= research_pdf_file_th.rsh_pdf_file.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= research_pdf_file_th.rsh_pdf_title.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fresearch_pdf_file_thview.Init();
</script>
<%
research_pdf_file_th_view.ShowPageFooter()
...
' Drop page object
Set research_pdf_file_th_view = Nothing
%>
<%
...
' Page Class
'
Class cresearch_pdf_file_th_view
	...
	Public Property Get PageObjName()
		PageObjName = "research_pdf_file_th_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_research_pdf_file_thlist.asp" ' Return to list
			End If

			' Get action
			research_pdf_file_th.CurrentAction = "I" ' Display form
			Select Case research_pdf_file_th.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_research_pdf_file_thlist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_research_pdf_file_thlist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		research_pdf_file_th.RowType = EW_ROWTYPE_VIEW
