...
' Define page object
Dim sys_admin_menu_view
Set sys_admin_menu_view = New csys_admin_menu_view
Set Page = sys_admin_menu_view

' Page init processing
sys_admin_menu_view.Page_Init()

' Page main processing
sys_admin_menu_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
sys_admin_menu_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If sys_admin_menu.Export = "" Then %>
<script type="text/javascript">
// Page object
var sys_admin_menu_view = new ew_Page("sys_admin_menu_view");
sys_admin_menu_view.PageID = "view"; // Page ID
var EW_PAGE_ID = sys_admin_menu_view.PageID; // For backward compatibility
// Form object
var fsys_admin_menuview = new ew_Form("fsys_admin_menuview");
// Form_CustomValidate event
fsys_admin_menuview.Form_CustomValidate = 
...
fsys_admin_menuview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fsys_admin_menuview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% sys_admin_menu_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not sys_admin_menu_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	sys_admin_menu_view.ActionOptions.Render "body", "", "", "", "", ""
	sys_admin_menu_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% sys_admin_menu_view.ShowPageHeader() %>
<% sys_admin_menu_view.ShowMessage %>
<form name="fsys_admin_menuview" id="fsys_admin_menuview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="sys_admin_menu">
<table class="ewGrid"><tr><td>
<table id="tbl_sys_admin_menuview" class="table table-bordered table-striped">
...
<%= sys_admin_menu.sys_admin_menu_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= sys_admin_menu.admin_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= sys_admin_menu.menu_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fsys_admin_menuview.Init();
</script>
<%
sys_admin_menu_view.ShowPageFooter()
...
' Drop page object
Set sys_admin_menu_view = Nothing
%>
<%
...
Class csys_admin_menu_view
	...
	Public Property Get PageObjName()
		PageObjName = "sys_admin_menu_view"
	End Property
	...
	Private Sub Class_Initialize()
		...
		If Request.QueryString("sys_admin_menu_id").Count > 0 Then
			ew_AddKey RecKey, "sys_admin_menu_id", Request.QueryString("sys_admin_menu_id")
			KeyUrl = KeyUrl & "&amp;sys_admin_menu_id=" & Server.URLEncode(Request.QueryString("sys_admin_menu_id"))
		End If
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_sys_admin_menulist.asp" ' Return to list
			End If

			' Get action
			sys_admin_menu.CurrentAction = "I" ' Display form
			Select Case sys_admin_menu.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_sys_admin_menulist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_sys_admin_menulist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		sys_admin_menu.RowType = EW_ROWTYPE_VIEW
