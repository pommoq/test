...
' ASPMaker configuration for Table e_library
Dim e_library
...
Class ce_library
	...
	Public Property Get HighlightName()
		HighlightName = "e_library_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [e_library]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_e_librarylist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_e_librarylist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_e_libraryview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_e_libraryview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_e_libraryedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_e_libraryadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_e_librarydelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [e_library] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get el_id()
		If Not IsObject(m_el_id) Then
			Set m_el_id = NewFldObj("e_library", "e_library", "x_el_id", "el_id", "[el_id]", "[el_id]", 3, 0, "[el_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get el_date()
		If Not IsObject(m_el_date) Then
			Set m_el_date = NewFldObj("e_library", "e_library", "x_el_date", "el_date", "[el_date]", "FORMAT([el_date], '')", 135, 8, "[el_date]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get el_title()
		If Not IsObject(m_el_title) Then
			Set m_el_title = NewFldObj("e_library", "e_library", "x_el_title", "el_title", "[el_title]", "[el_title]", 202, 0, "[el_title]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get el_pdf()
		If Not IsObject(m_el_pdf) Then
			Set m_el_pdf = NewFldObj("e_library", "e_library", "x_el_pdf", "el_pdf", "[el_pdf]", "[el_pdf]", 202, 0, "[el_pdf]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set el_pdf = m_el_pdf
	End Property
	...
	Public Property Get el_img()
		If Not IsObject(m_el_img) Then
			Set m_el_img = NewFldObj("e_library", "e_library", "x_el_img", "el_img", "[el_img]", "[el_img]", 202, 0, "[el_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
		Set el_img = m_el_img
	End Property
	...
	Public Property Get el_detail()
		If Not IsObject(m_el_detail) Then
			Set m_el_detail = NewFldObj("e_library", "e_library", "x_el_detail", "el_detail", "[el_detail]", "[el_detail]", 203, 0, "[el_detail]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get el_create()
		If Not IsObject(m_el_create) Then
			Set m_el_create = NewFldObj("e_library", "e_library", "x_el_create", "el_create", "[el_create]", "[el_create]", 202, 0, "[el_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get el_update()
		If Not IsObject(m_el_update) Then
			Set m_el_update = NewFldObj("e_library", "e_library", "x_el_update", "el_update", "[el_update]", "[el_update]", 202, 0, "[el_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
