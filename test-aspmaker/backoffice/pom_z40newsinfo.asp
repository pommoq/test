...
Class cz40news
	...
	Public Property Get HighlightName()
		HighlightName = "z40news_Highlight"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_z40newslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_z40newslist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_z40newsview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_z40newsview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_z40newsedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_z40newsadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_z40newsdelete.asp", UrlParm(""))
	End Function
...
'			End If
	...
	Public Property Get news_id()
		If Not IsObject(m_news_id) Then
			Set m_news_id = NewFldObj("z40news", "@news", "x_news_id", "news_id", "[news_id]", "[news_id]", 3, 0, "[news_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get news_img()
		If Not IsObject(m_news_img) Then
			Set m_news_img = NewFldObj("z40news", "@news", "x_news_img", "news_img", "[news_img]", "[news_img]", 202, 0, "[news_img]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_category()
		If Not IsObject(m_news_category) Then
			Set m_news_category = NewFldObj("z40news", "@news", "x_news_category", "news_category", "[news_category]", "[news_category]", 202, 0, "[news_category]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_subject()
		If Not IsObject(m_news_subject) Then
			Set m_news_subject = NewFldObj("z40news", "@news", "x_news_subject", "news_subject", "[news_subject]", "[news_subject]", 202, 0, "[news_subject]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_subject_th()
		If Not IsObject(m_news_subject_th) Then
			Set m_news_subject_th = NewFldObj("z40news", "@news", "x_news_subject_th", "news_subject_th", "[news_subject_th]", "[news_subject_th]", 202, 0, "[news_subject_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_intro()
		If Not IsObject(m_news_intro) Then
			Set m_news_intro = NewFldObj("z40news", "@news", "x_news_intro", "news_intro", "[news_intro]", "[news_intro]", 203, 0, "[news_intro]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_intro_th()
		If Not IsObject(m_news_intro_th) Then
			Set m_news_intro_th = NewFldObj("z40news", "@news", "x_news_intro_th", "news_intro_th", "[news_intro_th]", "[news_intro_th]", 203, 0, "[news_intro_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_content()
		If Not IsObject(m_news_content) Then
			Set m_news_content = NewFldObj("z40news", "@news", "x_news_content", "news_content", "[news_content]", "[news_content]", 203, 0, "[news_content]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_content_th()
		If Not IsObject(m_news_content_th) Then
			Set m_news_content_th = NewFldObj("z40news", "@news", "x_news_content_th", "news_content_th", "[news_content_th]", "[news_content_th]", 203, 0, "[news_content_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_show_en()
		If Not IsObject(m_news_show_en) Then
			Set m_news_show_en = NewFldObj("z40news", "@news", "x_news_show_en", "news_show_en", "[news_show_en]", "[news_show_en]", 202, 0, "[news_show_en]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_show()
		If Not IsObject(m_news_show) Then
			Set m_news_show = NewFldObj("z40news", "@news", "x_news_show", "news_show", "[news_show]", "[news_show]", 202, 0, "[news_show]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_create()
		If Not IsObject(m_news_create) Then
			Set m_news_create = NewFldObj("z40news", "@news", "x_news_create", "news_create", "[news_create]", "[news_create]", 202, 0, "[news_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get news_update()
		If Not IsObject(m_news_update) Then
			Set m_news_update = NewFldObj("z40news", "@news", "x_news_update", "news_update", "[news_update]", "[news_update]", 202, 0, "[news_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
