...
' Define page object
Dim video_view
Set video_view = New cvideo_view
Set Page = video_view
...
fvideoview.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fvideoview.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% video_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not video_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	video_view.ActionOptions.Render "body", "", "", "", "", ""
	video_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% video_view.ShowPageHeader() %>
<% video_view.ShowMessage %>
<form name="fvideoview" id="fvideoview" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="video">
<table class="ewGrid"><tr><td>
<table id="tbl_videoview" class="table table-bordered table-striped">
...
<span<%= video.video_detail.ViewAttributes %>>
<%= video.video_detail.ViewValue %>
</span>
</span>
</td>
	</tr>
...
Class cvideo_view
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_videolist.asp" ' Return to list
			End If

			' Get action
			video.CurrentAction = "I" ' Display form
			Select Case video.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_videolist.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_videolist.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		video.RowType = EW_ROWTYPE_VIEW
