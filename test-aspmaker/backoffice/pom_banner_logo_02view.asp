...
' Define page object
Dim banner_logo_02_view
Set banner_logo_02_view = New cbanner_logo_02_view
Set Page = banner_logo_02_view

' Page init processing
banner_logo_02_view.Page_Init()

' Page main processing
banner_logo_02_view.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
banner_logo_02_view.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<% If banner_logo_02.Export = "" Then %>
<script type="text/javascript">
// Page object
var banner_logo_02_view = new ew_Page("banner_logo_02_view");
banner_logo_02_view.PageID = "view"; // Page ID
var EW_PAGE_ID = banner_logo_02_view.PageID; // For backward compatibility
// Form object
var fbanner_logo_02view = new ew_Form("fbanner_logo_02view");
// Form_CustomValidate event
fbanner_logo_02view.Form_CustomValidate = 
...
fbanner_logo_02view.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fbanner_logo_02view.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% banner_logo_02_view.ExportOptions.Render "body", "", "", "", "", "" %>
<% If Not banner_logo_02_view.ExportOptions.UseDropDownButton Then %>
</div>
<div class="ewViewOtherOptions">
<% End If %>
<%
	banner_logo_02_view.ActionOptions.Render "body", "", "", "", "", ""
	banner_logo_02_view.DetailOptions.Render "body", "", "", "", "", ""
%>
</div>
<% End If %>
<% banner_logo_02_view.ShowPageHeader() %>
<% banner_logo_02_view.ShowMessage %>
<form name="fbanner_logo_02view" id="fbanner_logo_02view" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="t" value="banner_logo_02">
<table class="ewGrid"><tr><td>
<table id="tbl_banner_logo_02view" class="table table-bordered table-striped">
...
<%= banner_logo_02.banner_id.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_02.banner_img.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_02.banner_link.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_02.banner_sort.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_02.start_date.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<%= banner_logo_02.end_date.ViewValue %>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fbanner_logo_02view.Init();
</script>
<%
banner_logo_02_view.ShowPageFooter()
...
' Drop page object
Set banner_logo_02_view = Nothing
%>
<%
...
Class cbanner_logo_02_view
	...
	Public Property Get PageObjName()
		PageObjName = "banner_logo_02_view"
	End Property
	...
	Sub Page_Main()
		...
		If IsPageRequest Then ' Validate request
			...
			Else
				sReturnUrl = "pom_banner_logo_02list.asp" ' Return to list
			End If

			' Get action
			banner_logo_02.CurrentAction = "I" ' Display form
			Select Case banner_logo_02.CurrentAction
				Case "I" ' Get a record to display
					If Not LoadRow() Then ' Load record based on key
						...
						End If
						sReturnUrl = "pom_banner_logo_02list.asp" ' No matching record, return to list
					End If
			End Select
		Else
			sReturnUrl = "pom_banner_logo_02list.asp" ' Not page request, return to list
		End If
		If sReturnUrl <> "" Then Call Page_Terminate(sReturnUrl)

		' Render row
		banner_logo_02.RowType = EW_ROWTYPE_VIEW
