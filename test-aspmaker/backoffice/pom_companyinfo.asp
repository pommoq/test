...
' ASPMaker configuration for Table company
Dim company
...
Class ccompany
	...
	Public Property Get HighlightName()
		HighlightName = "company_Highlight"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "pom_companylist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "pom_companylist.asp"
	End Function

	' View url
	Public Function ViewUrl(parm)
		If parm <> "" Then
			ViewUrl = KeyUrl("pom_companyview.asp", UrlParm(parm))
		Else
			ViewUrl = KeyUrl("pom_companyview.asp", UrlParm(EW_TABLE_SHOW_DETAIL & "="))
		End If
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("pom_companyedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("pom_companyadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("pom_companydelete.asp", UrlParm(""))
	End Function
	...
	Function DeleteDetailRecords(Rs, Where)
		...
		If IsNull(Rs) Then
			Dim rsfile
			sSql = "SELECT * FROM [company] WHERE " & sWhereList
...
'			End If
	...
	Public Property Get company_id()
		If Not IsObject(m_company_id) Then
			Set m_company_id = NewFldObj("company", "company", "x_company_id", "company_id", "[company_id]", "[company_id]", 3, 0, "[company_id]", False, False, FALSE, "FORMATTED TEXT")
	...
	Public Property Get company_name_en()
		If Not IsObject(m_company_name_en) Then
			Set m_company_name_en = NewFldObj("company", "company", "x_company_name_en", "company_name_en", "[company_name_en]", "[company_name_en]", 202, 0, "[company_name_en]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get company_name_th()
		If Not IsObject(m_company_name_th) Then
			Set m_company_name_th = NewFldObj("company", "company", "x_company_name_th", "company_name_th", "[company_name_th]", "[company_name_th]", 202, 0, "[company_name_th]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get company_create()
		If Not IsObject(m_company_create) Then
			Set m_company_create = NewFldObj("company", "company", "x_company_create", "company_create", "[company_create]", "[company_create]", 202, 0, "[company_create]", False, False, FALSE, "FORMATTED TEXT")
		End If
	...
	Public Property Get company_update()
		If Not IsObject(m_company_update) Then
			Set m_company_update = NewFldObj("company", "company", "x_company_update", "company_update", "[company_update]", "[company_update]", 202, 0, "[company_update]", False, False, FALSE, "FORMATTED TEXT")
		End If
