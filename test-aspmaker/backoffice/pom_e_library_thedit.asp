...
' Define page object
Dim e_library_th_edit
Set e_library_th_edit = New ce_library_th_edit
Set Page = e_library_th_edit

' Page init processing
e_library_th_edit.Page_Init()

' Page main processing
e_library_th_edit.Page_Main()

' Global Page Rendering event (in userfn*.asp)
Page_Rendering()

' Page Rendering event
e_library_th_edit.Page_Render()
%>
<!--#include file="pom_header.asp"-->
<script type="text/javascript">
// Page object
var e_library_th_edit = new ew_Page("e_library_th_edit");
e_library_th_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = e_library_th_edit.PageID; // For backward compatibility
// Form object
var fe_library_thedit = new ew_Form("fe_library_thedit");
// Validate form
fe_library_thedit.Validate = function() {
...
fe_library_thedit.Form_CustomValidate = 
...
fe_library_thedit.ValidateRequired = true; // Use JavaScript validation
<% Else %>
fe_library_thedit.ValidateRequired = false; // No JavaScript validation
<% End If %>
...
<% Breadcrumb.Render() %>
<% End If %>
<% e_library_th_edit.ShowPageHeader() %>
<% e_library_th_edit.ShowMessage %>
<form name="fe_library_thedit" id="fe_library_thedit" class="ewForm form-inline" action="<%= ew_CurrentPage %>" method="post">
<input type="hidden" name="a_table" id="a_table" value="e_library_th">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_e_library_thedit" class="table table-bordered table-striped">
...
<%= e_library_th.el_id.EditValue %>
</span>
</span>
<input type="hidden" data-field="x_el_id" name="x_el_id" id="x_el_id" value="<%= Server.HTMLEncode(e_library_th.el_id.CurrentValue&"") %>">
...
<script type="text/javascript">
fe_library_thedit.Init();
<% If EW_MOBILE_REFLOW And ew_IsMobile() Then %>
ew_Reflow();
<% End If %>
</script>
<%
e_library_th_edit.ShowPageFooter()
...
Class ce_library_th_edit
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			e_library_th.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values
		Else
			e_library_th.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If e_library_th.el_id.CurrentValue = "" Then Call Page_Terminate("pom_e_library_thlist.asp") ' Invalid key, return to list

		' Validate form if post back
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			If Not ValidateForm() Then
				e_library_th.CurrentAction = "" ' Form error, reset action
		...
		Select Case e_library_th.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				e_library_th.SendEmail = True ' Send email on update success
		...
		' Render the record
		e_library_th.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Sub RenderRow()
		...
		ElseIf e_library_th.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' el_id
			e_library_th.el_id.EditCustomAttributes = ""
			e_library_th.el_id.EditValue = e_library_th.el_id.CurrentValue
			e_library_th.el_id.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			Call e_library_th.el_date.SetDbValue(Rs, e_library_th.el_date.CurrentValue, Null, e_library_th.el_date.ReadOnly)

			' Field el_title
			Call e_library_th.el_title.SetDbValue(Rs, e_library_th.el_title.CurrentValue, Null, e_library_th.el_title.ReadOnly)

			' Field el_pdf
			Call e_library_th.el_pdf.SetDbValue(Rs, e_library_th.el_pdf.CurrentValue, Null, e_library_th.el_pdf.ReadOnly)

			' Field el_img
			Call e_library_th.el_img.SetDbValue(Rs, e_library_th.el_img.CurrentValue, Null, e_library_th.el_img.ReadOnly)

			' Field el_detail
			Call e_library_th.el_detail.SetDbValue(Rs, e_library_th.el_detail.CurrentValue, Null, e_library_th.el_detail.ReadOnly)

			' Field el_create
			Call e_library_th.el_create.SetDbValue(Rs, e_library_th.el_create.CurrentValue, Null, e_library_th.el_create.ReadOnly)

			' Field el_update
			Call e_library_th.el_update.SetDbValue(Rs, e_library_th.el_update.CurrentValue, Null, e_library_th.el_update.ReadOnly)
			...
			bUpdateRow = e_library_th.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call e_library_th.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
